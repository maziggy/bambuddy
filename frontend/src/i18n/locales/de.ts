export default {
  ...
  login: {
    ...
    twoFA: {
      ...
      subtitle: 'Dein Konto ist mit 2FA geschützt. Gib unten den Bestätigungscode ein.',
      methodAuthenticator: 'Authenticator-App',
      methodEmail: 'E-Mail-Code',
      methodBackup: 'Backup-Code',
      instructionsTotp: 'Öffne deine Authenticator-App und gib den 6-stelligen Code für Bambuddy ein.',
      instructionsEmail: 'Ein 6-stelliger Code wurde an deine E-Mail-Adresse gesendet. Er läuft in 10 Minuten ab.',
      instructionsEmailNotSent: 'Klicke unten, um einen Bestätigungscode per E-Mail zu erhalten.',
      instructionsBackup: 'Gib einen deiner 8-stelligen Backup-Codes ein. Jeder Code kann nur einmal verwendet werden.',
