export default {
  ...
  settings: {
    ...
    lockSidebarOrder: 'Blocca ordine',
    unlockSidebarOrder: 'Sblocca ordine',
    sidebarOrderLocked: 'Ordine della barra laterale bloccato per tutti gli utenti.',
    sidebarOrderUnlocked: 'Ordine della barra laterale sbloccato. Gli utenti possono personalizzare il loro ordine.',
    sidebarOrderLockFailed: 'Impossibile bloccare l\'ordine della barra laterale.',
    sidebarOrderUnlockFailed: 'Impossibile sbloccare l\'ordine della barra laterale.',
    reset: 'Ripristina',
