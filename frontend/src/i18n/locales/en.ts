export default {
  ...
  settings: {
    ...
    cameraVideoProcessingSoftware: 'Software processing',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: 'Uses the CPU for H.264 decoding and MJPEG encoding.',
    cameraVideoProcessingIntelQsvDescription: 'Uses Intel Quick Sync for hardware H.264 decoding and MJPEG encoding. Requires FFmpeg with QSV/VAAPI support and access to a DRM render device.',
    cameraVideoProcessingReconnectDescription: 'Changes take effect after the current shared camera stream stops and reconnects.',
    qsvDiagnosticStageFfmpeg: 'FFmpeg',
    qsvDiagnosticStageDevice: 'Intel GPU device',
    qsvDiagnosticStageCodecs: 'Required QSV codecs',
    qsvDiagnosticStageInitialization: 'Quick Sync initialization',
    qsvDiagnosticFfmpegMissing: 'FFmpeg is not installed or is not available in PATH.',
    qsvDiagnosticDeviceMissing: 'No accessible GPU render device was found. Pass the Intel GPU render device into the container.',
    qsvDiagnosticPermissionDenied: 'Bambuddy cannot access the GPU render device. Check the render group and container device permissions.',
    qsvDiagnosticDecoderMissing: 'This FFmpeg build does not provide the h264_qsv decoder.',
    qsvDiagnosticEncoderMissing: 'This FFmpeg build does not provide the mjpeg_qsv encoder.',
    qsvDiagnosticCodecsMissing: 'This FFmpeg build does not provide the required QSV codecs.',
    qsvDiagnosticInitializationFailed: 'The Intel GPU was found, but Quick Sync could not be initialized. Check the Intel media driver and oneVPL runtime.',
    qsvDiagnosticTimeout: 'The Quick Sync diagnostic timed out.',
    qsvDiagnosticUnknownFailure: 'Quick Sync is not available. Open the details below for diagnostic information.',
    qsvDiagnosticManualDescription: 'Run a compatibility check before using Intel Quick Sync.',
    qsvDiagnosticRun: 'Run compatibility check',
    qsvDiagnosticRunning: 'Checking Intel Quick Sync availability...',
    qsvDiagnosticRequestFailed: 'Could not run the Quick Sync diagnostic.',
    qsvDiagnosticRetry: 'Check again',
    qsvDiagnosticAvailable: 'Intel Quick Sync is available',
    qsvDiagnosticUnavailable: 'Intel Quick Sync is unavailable',
    qsvDiagnosticAvailableDescription: 'The Intel GPU, FFmpeg codecs and hardware initialization were checked successfully.',
    qsvDiagnosticHideDetails: 'Hide details',
    qsvDiagnosticShowDetails: 'Show details',
