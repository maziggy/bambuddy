export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: 'Elaborazione video',
    cameraVideoProcessingSoftware: 'Elaborazione software',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: 'Utilizza la CPU per decodificare H.264 e codificare MJPEG.',
    cameraVideoProcessingIntelQsvDescription: 'Utilizza Intel Quick Sync per la decodifica hardware H.264 e la codifica MJPEG. Richiede FFmpeg con supporto QSV/VAAPI e accesso a un dispositivo di rendering DRM.',
    cameraVideoProcessingReconnectDescription: 'Le modifiche vengono applicate dopo che il flusso condiviso corrente della videocamera viene arrestato e riconnesso.',
    qsvDiagnosticStageFfmpeg: 'FFmpeg',
    qsvDiagnosticStageDevice: 'Dispositivo GPU Intel',
    qsvDiagnosticStageCodecs: 'Codec QSV richiesti',
    qsvDiagnosticStageInitialization: 'Inizializzazione Quick Sync',
    qsvDiagnosticFfmpegMissing: 'FFmpeg non è installato o non è disponibile nel PATH.',
    qsvDiagnosticDeviceMissing: 'Non è stato trovato alcun dispositivo di rendering GPU accessibile. Passa il dispositivo della GPU Intel al container.',
    qsvDiagnosticPermissionDenied: 'Bambuddy non può accedere al dispositivo di rendering GPU. Controlla il gruppo render e i permessi del dispositivo nel container.',
    qsvDiagnosticDecoderMissing: 'Questa versione di FFmpeg non include il decoder h264_qsv.',
    qsvDiagnosticEncoderMissing: "Questa versione di FFmpeg non include l'encoder mjpeg_qsv.",
    qsvDiagnosticCodecsMissing: 'Questa versione di FFmpeg non include i codec QSV richiesti.',
    qsvDiagnosticInitializationFailed: 'La GPU Intel è stata rilevata, ma non è stato possibile inizializzare Quick Sync. Controlla il driver Intel Media e il runtime oneVPL.',
    ...
    qsvDiagnosticTimeout: 'Il controllo Quick Sync ha superato il tempo massimo.',
    qsvDiagnosticUnknownFailure: 'Quick Sync non è disponibile. Apri i dettagli qui sotto per le informazioni diagnostiche.',
    qsvDiagnosticManualDescription: 'Esegui un controllo di compatibilità prima di utilizzare Intel Quick Sync.',
    qsvDiagnosticRun: 'Controlla compatibilità',
    qsvDiagnosticRunning: 'Verifica della disponibilità di Intel Quick Sync...',
    qsvDiagnosticRequestFailed: 'Impossibile eseguire il controllo Quick Sync.',
    qsvDiagnosticRetry: 'Controlla di nuovo',
    qsvDiagnosticAvailable: 'Intel Quick Sync è disponibile',
    qsvDiagnosticUnavailable: 'Intel Quick Sync non è disponibile',
    qsvDiagnosticAvailableDescription: 'GPU Intel, codec FFmpeg e inizializzazione hardware verificati correttamente.',
    qsvDiagnosticHideDetails: 'Nascondi dettagli',
    qsvDiagnosticShowDetails: 'Mostra dettagli',
