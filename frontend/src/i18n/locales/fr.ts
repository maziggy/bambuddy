export default {
  ...
  settings: {
    ...
    lockSidebarOrder: 'Verrouiller l\'ordre',
    unlockSidebarOrder: 'Déverrouiller l\'ordre',
    sidebarOrderLocked: 'Ordre de la barre latérale verrouillé pour tous les utilisateurs.',
    sidebarOrderUnlocked: 'Ordre de la barre latérale déverrouillé. Les utilisateurs peuvent personnaliser leur ordre.',
    sidebarOrderLockFailed: 'Échec du verrouillage de l\'ordre de la barre latérale.',
    sidebarOrderUnlockFailed: 'Échec du déverrouillage de l\'ordre de la barre latérale.',
    reset: 'Réinitialiser',
