export default {
  ...
  printers: {
    ...
    enclosure: {
      sectionTitle: 'Gabinete',
      temperature: 'Temperatura',
      humidity: 'Umidade',
      fan: 'Ventilador do gabinete',
      fanOn: 'ON',
      fanOff: 'OFF',
      noEntitiesHint: 'Configure as entidades de sensor do Home Assistant nas configurações da impressora para exibir as leituras.',
      noDataHint: 'Sem dados ainda — verifique se o Home Assistant está configurado em Configurações → Integrações.',
      haNotConfiguredWarning: 'O Home Assistant não está configurado. Acesse Configurações → Integrações e insira sua URL do HA e o token primeiro.',
      editLabel: 'Impressora com gabinete fechado',
      editDescription: 'Exibe uma seção de gabinete dedicada no cartão da impressora para temperatura e umidade.',
      editEntitiesHint: 'Insira os IDs de entidade do Home Assistant para os sensores do gabinete. As leituras são atualizadas a cada 60 segundos.',
      tempEntity: 'Entidade de temperatura',
      humidityEntity: 'Entidade de umidade',
      fanEntity: 'Entidade de ventilador',
      historyTitle: 'Histórico do gabinete',
      currentTemp: 'Temp. atual',
      currentHumidity: 'Umidade atual',
      minMax: 'Mín / Máx',
      tempChartLabel: 'Temperatura ({{unit}})',
      humidityChartLabel: 'Umidade ({{unit}})',
      noReadings: 'Nenhuma leitura registrada neste intervalo de tempo.',
      readingsNote: 'As leituras são registradas a cada 60 segundos enquanto o BamBuddy está em execução.',
      fanHistoryTitle: 'Histórico do ventilador do gabinete',
      fanTotalRuntime: 'Tempo total de funcionamento',
      fanRuns: 'Ciclos',
      fanAvgRun: 'Ciclo médio',
      fanLongestRun: 'Ciclo mais longo',
      fanNoActivity: 'Nenhuma atividade do ventilador registrada neste intervalo de tempo.',
      pollNote: 'O estado é verificado a cada 60 segundos enquanto o BamBuddy está em execução.',
    },
    ...
    wled: {
      sectionTitle: 'Fita LED WLED',
      sectionDescription: 'Conecte um dispositivo WLED para exibir o estado desta impressora como uma cor em uma fita LED.',
      enabledLabel: 'Ativar WLED para esta impressora',
      host: 'Host / IP WLED',
      hostPlaceholder: '192.168.1.50 ou wled.local',
      port: 'Porta',
      apiKey: 'Chave de API (opcional)',
      apiKeyPlaceholder: 'Deixe vazio se não definida',
      testConnection: 'Testar conexão',
      testEffect: 'Piscar LED',
      connected: 'Conectado',
      disconnected: 'Inacessível',
  ...
  storage: {
    title: 'Armazenamento de Filamento',
    emptyState: 'Nenhuma unidade ainda. Adicione um secador ou caixa seca para começar.',
    addUnit: 'Adicionar Unidade',
    editUnit: 'Editar Unidade',
    deleteUnit: 'Excluir Unidade',
    deleteConfirm: 'Excluir "{{name}}"? Todas as leituras históricas também serão removidas.',
    typeDryer: 'Secador',
    typeStorage: 'Caixa Seca / Armazenamento',
    filterAll: 'Todos',
    filterDryers: 'Secadores',
    filterStorage: 'Caixas Secas',
    temperature: 'Temperatura',
    humidity: 'Umidade',
    noReading: 'Sem leitura ainda',
    noEntitiesHint: 'Nenhuma entidade de sensor HA — adicione em Editar.',
    noDataHint: 'Entidades configuradas mas sem dados. Sondagem HA a cada 60 s.',
    historyTitle: 'Histórico do Sensor',
    history24h: 'Últimas 24 h',
    history48h: 'Últimas 48 h',
    history7d: 'Últimos 7 dias',
    noHistory: 'Sem leituras no período selecionado.',
    modalNameLabel: 'Nome',
    modalNamePlaceholder: 'ex. Sunlu S1 Plus, Caixa Seca A',
    modalTypeLabel: 'Tipo',
    modalTempEntityLabel: 'Entidade de Temperatura HA',
    modalTempEntityPlaceholder: 'sensor.secador_temperatura',
    modalHumidityEntityLabel: 'Entidade de Umidade HA',
    modalHumidityEntityPlaceholder: 'sensor.secador_umidade',
    modalNotesLabel: 'Notas (opcional)',
    modalNotesPlaceholder: 'ex. Secando PETG + PA a 70 °C',
    modalSave: 'Salvar',
    modalCancel: 'Cancelar',
    savedToast: 'Unidade de armazenamento salva',
    deletedToast: 'Unidade de armazenamento excluída',
  },
  ...
  settings: {
    ...
    // WLED
    wled: 'WLED',
    wledDescription: 'Controle fitas LED WLED para visualizar o estado da impressora. Cada impressora se conecta ao seu próprio dispositivo WLED e exibe a cor definida no mapa de estados global abaixo.',
    enableWled: 'Ativar integração WLED',
    wledEnableDescription: 'Enviar cores de estado da impressora para dispositivos WLED por impressora',
    wledStateMapTitle: 'Mapa de cores de estado',
    wledStateMapDescription: 'Defina a cor, o brilho e o efeito para cada estado da impressora. Todas as impressoras compartilham este mapa.',
    wledStatePrinting: 'Imprimindo',
    wledStateIdle: 'Ocioso',
    wledStateFinished: 'Concluído',
    wledStateError: 'Erro / Falha',
    wledStatePaused: 'Pausado',
    wledStatePreparing: 'Preparando',
    wledStateOffline: 'Desligado / Offline',
    wledColour: 'Cor',
    wledBrightness: 'Brilho',
    wledEffectId: 'ID de efeito',
    wledEffectIdHint: '0 = Sólido. Consulte a lista de efeitos WLED para os IDs.',
    wledPresetId: 'ID de predefinição',
    wledPresetIdHint: 'Se definido, ativa esta predefinição WLED em vez de cor/efeito.',
    wledPresetNone: 'Nenhum (usar cor)',
    // Smart Plugs
