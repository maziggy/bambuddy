export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: '当扫描到的条形码尚未存在于您的库存中时，查询社区维护的 Open Filament Database。关闭后仅匹配您以前扫描过的条形码——扫描功能本身始终可用。',
      refreshNow: '立即刷新数据库',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      takePhoto: '拍照',
      choosePhoto: '选择照片',
      manualHint: '输入料盘包装上印刷的条形码',
      manualPlaceholder: '例如 6938936716785',
      manualInvalid: '请输入有效的 UPC-A、EAN-8 或 EAN-13 条形码（8、12 或 13 位数字）',
      lookUp: '查询',
      lookingUp: '正在查询条形码…',
