export default {
  ...
  login: {
    ...
    twoFA: {
      ...
      subtitle: 'Votre compte est protégé par 2FA. Entrez le code de vérification ci-dessous.',
      methodAuthenticator: 'Application Authenticator',
      methodEmail: 'Code par e-mail',
      methodBackup: 'Code de secours',
      instructionsTotp: 'Ouvrez votre application authenticator et entrez le code à 6 chiffres pour Bambuddy.',
      instructionsEmail: 'Un code à 6 chiffres a été envoyé à votre adresse e-mail. Il expire dans 10 minutes.',
      instructionsEmailNotSent: 'Cliquez ci-dessous pour recevoir un code de vérification par e-mail.',
      instructionsBackup: 'Entrez l\'un de vos codes de secours à 8 caractères. Chaque code ne peut être utilisé qu\'une seule fois.',
