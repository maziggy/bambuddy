export default {
  ...
  settings: {
    ...
    lockSidebarOrder: '锁定顺序',
    unlockSidebarOrder: '解锁顺序',
    sidebarOrderLocked: '侧边栏顺序已为所有用户锁定。',
    sidebarOrderUnlocked: '侧边栏顺序已解锁。用户现在可以自定义顺序。',
    sidebarOrderLockFailed: '锁定侧边栏顺序失败。',
    sidebarOrderUnlockFailed: '解锁侧边栏顺序失败。',
    reset: '重置',
    darkMode: '深色模式',
    lightMode: '浅色模式',
    active: '(当前)',
