export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: '當掃描的條碼尚未存在於您的庫存中時，查詢社群維護的 Open Filament Database。關閉後僅比對您先前掃描過的條碼——掃描功能本身一律可用。',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualInvalid: '請輸入有效的 UPC-A、EAN-8 或 EAN-13 條碼（8、12 或 13 位數字）',
      lookUp: '查詢',
      lookingUp: '正在查詢條碼…',
