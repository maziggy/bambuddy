export default {
  ...
  settings: {
    ...
    ldap: {
      ...
      groupMappingHint: 'Mapear DNs de grupos LDAP para grupos do BamBuddy. Grupos disponíveis: ',
    ...
    oidc: {
      ...
      form: {
        ...
        claimNotInScopesWarning: 'O provedor de identidade só retornará o claim \'{{claim}}\' se \'{{claim}}\' estiver incluído nos Scopes.',
      },
    },
