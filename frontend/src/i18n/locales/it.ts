export default {
  ...
  printers: {
    ...
    enclosure: {
      sectionTitle: 'Alloggiamento',
      temperature: 'Temperatura',
      humidity: 'Umidità',
      fan: 'Ventola alloggiamento',
      fanOn: 'ON',
      fanOff: 'OFF',
      noEntitiesHint: 'Configura le entità sensore di Home Assistant nelle impostazioni della stampante per visualizzare le letture.',
      noDataHint: 'Nessun dato ancora — verifica che Home Assistant sia configurato in Impostazioni → Integrazioni.',
      haNotConfiguredWarning: 'Home Assistant non è configurato. Vai in Impostazioni → Integrazioni e inserisci prima l\'URL HA e il token.',
      editLabel: 'Stampante con alloggiamento',
      editDescription: 'Mostra una sezione alloggiamento dedicata sulla scheda stampante per temperatura e umidità.',
      editEntitiesHint: 'Inserisci gli ID entità di Home Assistant per i sensori dell\'alloggiamento. Le letture si aggiornano ogni 60 secondi.',
      tempEntity: 'Entità temperatura',
      humidityEntity: 'Entità umidità',
      fanEntity: 'Entità ventola',
      historyTitle: 'Cronologia alloggiamento',
      currentTemp: 'Temp. attuale',
      currentHumidity: 'Umidità attuale',
      minMax: 'Min / Max',
      tempChartLabel: 'Temperatura ({{unit}})',
      humidityChartLabel: 'Umidità ({{unit}})',
      noReadings: 'Nessuna lettura registrata in questo intervallo di tempo.',
      readingsNote: 'Le letture vengono registrate ogni 60 secondi mentre BamBuddy è in esecuzione.',
      fanHistoryTitle: 'Cronologia ventola alloggiamento',
      fanTotalRuntime: 'Tempo di funzionamento totale',
      fanRuns: 'Cicli',
      fanAvgRun: 'Ciclo medio',
      fanLongestRun: 'Ciclo più lungo',
      fanNoActivity: 'Nessuna attività della ventola registrata in questo intervallo di tempo.',
      pollNote: 'Lo stato viene verificato ogni 60 secondi mentre BamBuddy è in esecuzione.',
    },
    ...
    wled: {
      sectionTitle: 'Striscia LED WLED',
      sectionDescription: 'Collega un dispositivo WLED per mostrare lo stato di questa stampante come un colore su una striscia LED.',
      enabledLabel: 'Abilita WLED per questa stampante',
      host: 'Host / IP WLED',
      hostPlaceholder: '192.168.1.50 o wled.local',
      port: 'Porta',
      apiKey: 'Chiave API (facoltativo)',
      apiKeyPlaceholder: 'Lascia vuoto se non impostata',
      testConnection: 'Verifica connessione',
      testEffect: 'Lampeggia LED',
      connected: 'Connesso',
      disconnected: 'Non raggiungibile',
      deviceInfo: '{{name}} · WLED {{version}} · {{leds}} LED',
    },
    // ROI editor
    roi: {
  ...
  storage: {
    title: 'Conservazione Filamento',
    emptyState: 'Nessuna unità ancora. Aggiungi un essiccatore o una scatola asciutta.',
    addUnit: 'Aggiungi unità',
    editUnit: 'Modifica unità',
    deleteUnit: 'Elimina unità',
    deleteConfirm: 'Eliminare "{{name}}"? Verranno rimosse anche tutte le letture storiche.',
    typeDryer: 'Essiccatore',
    typeStorage: 'Scatola secca / Conservazione',
    filterAll: 'Tutti',
    filterDryers: 'Essiccatori',
    filterStorage: 'Scatole secche',
    temperature: 'Temperatura',
    humidity: 'Umidità',
    noReading: 'Nessuna lettura ancora',
    noEntitiesHint: 'Nessuna entità sensore HA — aggiungile in Modifica.',
    noDataHint: 'Entità configurate ma nessun dato ancora. Polling HA ogni 60 s.',
    historyTitle: 'Cronologia sensore',
    history24h: 'Ultime 24 h',
    history48h: 'Ultime 48 h',
    history7d: 'Ultimi 7 giorni',
    noHistory: 'Nessuna lettura nel periodo selezionato.',
    modalNameLabel: 'Nome',
    modalNamePlaceholder: 'es. Sunlu S1 Plus, Scatola secca A',
    modalTypeLabel: 'Tipo',
    modalTempEntityLabel: 'Entità temperatura HA',
    modalTempEntityPlaceholder: 'sensor.essiccatore_temperatura',
    modalHumidityEntityLabel: 'Entità umidità HA',
    modalHumidityEntityPlaceholder: 'sensor.essiccatore_umidita',
    modalNotesLabel: 'Note (facoltativo)',
    modalNotesPlaceholder: 'es. Essiccazione PETG + PA a 70 °C',
    modalSave: 'Salva',
    modalCancel: 'Annulla',
    savedToast: 'Unità salvata',
    deletedToast: 'Unità eliminata',
  },
  ...
  settings: {
    ...
    // WLED
    wled: 'WLED',
    wledDescription: 'Controlla strisce LED WLED per visualizzare lo stato della stampante. Ogni stampante si connette al proprio dispositivo WLED e mostra il colore definito nella mappa stati globale di seguito.',
    enableWled: 'Abilita integrazione WLED',
    wledEnableDescription: 'Invia i colori di stato della stampante ai dispositivi WLED per ogni stampante',
    wledStateMapTitle: 'Mappa colori stati',
    wledStateMapDescription: 'Definisci il colore, la luminosità e l\'effetto per ogni stato della stampante. Tutte le stampanti condividono questa mappa.',
    wledStatePrinting: 'In stampa',
    wledStateIdle: 'In attesa',
    wledStateFinished: 'Completato',
    wledStateError: 'Errore / Fallito',
    wledStatePaused: 'In pausa',
    wledStatePreparing: 'Preparazione',
    wledStateOffline: 'Non in linea / Spento',
    wledColour: 'Colore',
    wledBrightness: 'Luminosità',
    wledEffectId: 'ID effetto',
    wledEffectIdHint: '0 = Tinta unita. Consulta la lista effetti WLED per gli ID.',
    wledPresetId: 'ID preset',
    wledPresetIdHint: 'Se impostato, attiva questo preset WLED invece di colore/effetto.',
    wledPresetNone: 'Nessuno (usa il colore)',
    // Smart Plugs
