export default {
  ...
  settings: {
    ...
    lockSidebarOrder: '順序をロック',
    unlockSidebarOrder: '順序をロック解除',
    sidebarOrderLocked: 'サイドバーの順序がすべてのユーザーにロックされました。',
    sidebarOrderUnlocked: 'サイドバーの順序がロック解除されました。ユーザーは順序をカスタマイズできます。',
    sidebarOrderLockFailed: 'サイドバーの順序のロックに失敗しました。',
    sidebarOrderUnlockFailed: 'サイドバーの順序のロック解除に失敗しました。',
    reset: 'リセット',
    // Appearance
    darkMode: 'ダークモード',
    lightMode: 'ライトモード',
