...
- **Queue auto-drying** — Automatically dry filament between scheduled prints when humidity exceeds the fair threshold, then continue until the good threshold or configured drying duration is reached; configurable presets per filament type, optional blocking mode
