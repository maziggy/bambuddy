export default {
  ...
  wled: {
    ...
    presetSegmentHint: 'Wähle das Zielsegment beim Erstellen des Presets direkt in WLED aus und aktiviere „Checked segments only“. Zur Laufzeit aktiviert Bambuddy ausschließlich das konfigurierte Preset.',
