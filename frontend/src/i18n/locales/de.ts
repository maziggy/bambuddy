export default {
  ...
  printers: {
    ...
    enclosure: {
      sectionTitle: 'Gehäuse',
      temperature: 'Temperatur',
      humidity: 'Luftfeuchtigkeit',
      fan: 'Gehäuselüfter',
      fanOn: 'ON',
      fanOff: 'OFF',
      noEntitiesHint: 'Konfiguriere Home Assistant Sensor-Entitäten in den Druckereinstellungen, um Messwerte anzuzeigen.',
      noDataHint: 'Noch keine Daten — prüfe, ob Home Assistant in Einstellungen → Integrationen konfiguriert ist.',
      haNotConfiguredWarning: 'Home Assistant ist nicht konfiguriert. Gehe zu Einstellungen → Integrationen und gib zuerst deine HA-URL und den Token ein.',
      editLabel: 'Drucker mit Gehäuse',
      editDescription: 'Zeigt einen eigenen Gehäusebereich auf der Druckerkarte für Temperatur und Luftfeuchtigkeit.',
      editEntitiesHint: 'Gib Home Assistant Entitäts-IDs für deine Gehäusesensoren ein. Messwerte werden alle 60 Sekunden aktualisiert.',
      tempEntity: 'Temperatur-Entität',
      humidityEntity: 'Luftfeuchtigkeits-Entität',
      fanEntity: 'Lüfter-Entität',
      historyTitle: 'Gehäuseverlauf',
      currentTemp: 'Aktuelle Temp.',
      currentHumidity: 'Aktuelle Luftfeuchtigkeit',
      minMax: 'Min / Max',
      tempChartLabel: 'Temperatur ({{unit}})',
      humidityChartLabel: 'Luftfeuchtigkeit ({{unit}})',
      noReadings: 'Keine Messwerte in diesem Zeitraum aufgezeichnet.',
      readingsNote: 'Messwerte werden alle 60 Sekunden aufgezeichnet, während BamBuddy läuft.',
      fanHistoryTitle: 'Gehäuselüfter-Verlauf',
      fanTotalRuntime: 'Gesamtlaufzeit',
      fanRuns: 'Läufe',
      fanAvgRun: 'Durchschn. Lauf',
      fanLongestRun: 'Längster Lauf',
      fanNoActivity: 'Keine Lüfteraktivität in diesem Zeitraum aufgezeichnet.',
      pollNote: 'Der Zustand wird alle 60 Sekunden überprüft, während BamBuddy läuft.',
    },
    ...
    wled: {
      sectionTitle: 'WLED LED-Streifen',
      sectionDescription: 'Ein WLED-Gerät verbinden, um den Status dieses Druckers als Farbe auf einem LED-Streifen anzuzeigen.',
      enabledLabel: 'WLED für diesen Drucker aktivieren',
      host: 'WLED Host / IP',
      hostPlaceholder: '192.168.1.50 oder wled.local',
      port: 'Port',
      apiKey: 'API-Schlüssel (optional)',
      apiKeyPlaceholder: 'Leer lassen, wenn nicht gesetzt',
      testConnection: 'Verbindung testen',
      testEffect: 'LED aufblitzen',
      connected: 'Verbunden',
  ...
  storage: {
    title: 'Filamentlagerung',
    emptyState: 'Noch keine Lagerungseinheiten. Füge einen Trockner oder eine Trockenbox hinzu.',
    addUnit: 'Einheit hinzufügen',
    editUnit: 'Einheit bearbeiten',
    deleteUnit: 'Einheit löschen',
    deleteConfirm: '"{{name}}" löschen? Alle historischen Messwerte werden ebenfalls gelöscht.',
    typeDryer: 'Trockner',
    typeStorage: 'Trockenbox / Lagerung',
    filterAll: 'Alle',
    filterDryers: 'Trockner',
    filterStorage: 'Trockenboxen',
    temperature: 'Temperatur',
    humidity: 'Luftfeuchtigkeit',
    noReading: 'Noch kein Messwert',
    noEntitiesHint: 'Keine HA-Sensorentitäten konfiguriert — füge sie unter Bearbeiten hinzu.',
    noDataHint: 'Entitäten konfiguriert, aber noch keine Daten. HA-Abfrage alle 60 s.',
    historyTitle: 'Sensorverlauf',
    history24h: 'Letzte 24 h',
    history48h: 'Letzte 48 h',
    history7d: 'Letzte 7 Tage',
    noHistory: 'Keine Messwerte im gewählten Zeitraum.',
    modalNameLabel: 'Name',
    modalNamePlaceholder: 'z. B. Sunlu S1 Plus, Trockenbox A',
    modalTypeLabel: 'Typ',
    modalTempEntityLabel: 'HA Temperatur-Entität',
    modalTempEntityPlaceholder: 'sensor.trockner_temperatur',
    modalHumidityEntityLabel: 'HA Feuchtigkeits-Entität',
    modalHumidityEntityPlaceholder: 'sensor.trockner_luftfeuchtigkeit',
    modalNotesLabel: 'Notizen (optional)',
    modalNotesPlaceholder: 'z. B. PETG + PA bei 70 °C trocknen',
    modalSave: 'Speichern',
    modalCancel: 'Abbrechen',
    savedToast: 'Lagerungseinheit gespeichert',
    deletedToast: 'Lagerungseinheit gelöscht',
  },
  ...
  settings: {
    ...
    // WLED
    wled: 'WLED',
    wledDescription: 'WLED-LED-Streifen steuern, um den Druckerstatus zu visualisieren. Jeder Drucker verbindet sich mit seinem eigenen WLED-Gerät.',
    enableWled: 'WLED-Integration aktivieren',
    wledEnableDescription: 'Druckerstatusfarben an WLED-Geräte senden',
    wledStateMapTitle: 'Zustandsfarbkarte',
    wledStateMapDescription: 'Farbe, Helligkeit und Effekt für jeden Druckerstatus festlegen. Alle Drucker teilen diese Karte.',
    wledStatePrinting: 'Drucken',
    wledStateIdle: 'Bereit',
    wledStateFinished: 'Fertig',
    wledStateError: 'Fehler / Fehlgeschlagen',
    wledStatePaused: 'Pausiert',
    wledStatePreparing: 'Vorbereitung',
    wledStateOffline: 'Offline / Aus',
    wledColour: 'Farbe',
    wledBrightness: 'Helligkeit',
    wledEffectId: 'Effekt-ID',
    wledEffectIdHint: '0 = Einfarbig. WLED-Effektliste für IDs ansehen.',
    wledPresetId: 'Preset-ID',
    wledPresetIdHint: 'Falls gesetzt, wird dieses WLED-Preset statt Farbe/Effekt aktiviert.',
    wledPresetNone: 'Keines (Farbe verwenden)',
    // Smart Plugs
