export default {
  ...
  printers: {
    ...
    cameraGrid: {
      ...
      reconnecting: 'Reconnexion dans {{countdown}}s ({{attempt}}/{{max}})',
      expand: 'Agrandir',
      layout: {
        compact: 'Compact',
        default: 'Normal',
  ...
  settings: {
    ...
    cameraQualityAuto: 'Auto (Recommandé)',
    cameraQualityAutoResolved: 'Sélection automatique : {{resolved}} selon le matériel du serveur et le nombre d\'imprimantes.',
