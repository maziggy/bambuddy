export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: '스캔한 바코드가 아직 재고에 없을 때 커뮤니티 Open Filament Database를 조회합니다. 이전에 스캔한 바코드만 일치시키려면 꺼두세요 — 스캔 기능 자체는 항상 작동합니다.',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualInvalid: '유효한 UPC-A, EAN-8 또는 EAN-13 바코드를 입력하세요 (8, 12 또는 13자리)',
      lookUp: '조회',
      lookingUp: '바코드 조회 중…',
