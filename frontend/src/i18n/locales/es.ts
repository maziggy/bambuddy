export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: 'Consulta la Open Filament Database de la comunidad cuando un código de barras escaneado aún no está en tu inventario. Desactívalo para solo coincidir con códigos ya escaneados antes — el escaneo en sí siempre sigue funcionando.',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualHint: 'Escribe el código de barras impreso en la caja del carrete',
      manualPlaceholder: 'p. ej. 6938936716785',
      manualInvalid: 'Introduce un código UPC-A, EAN-8 o EAN-13 válido (8, 12 o 13 dígitos)',
      lookUp: 'Buscar',
