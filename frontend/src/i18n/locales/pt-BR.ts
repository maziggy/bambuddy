export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: 'Consulta o Open Filament Database da comunidade quando um código de barras escaneado ainda não está no seu inventário. Desative para corresponder apenas a códigos já escaneados antes — o próprio escaneamento sempre continua funcionando.',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualInvalid: 'Digite um código de barras UPC-A, EAN-8 ou EAN-13 válido (8, 12 ou 13 dígitos)',
      lookUp: 'Buscar',
