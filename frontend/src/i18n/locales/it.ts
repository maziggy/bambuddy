export default {
  ...
  printers: {
    ...
    cameraGrid: {
      ...
      reconnecting: 'Riconnessione tra {{countdown}}s ({{attempt}}/{{max}})',
      expand: 'Espandi',
      layout: {
        compact: 'Compatto',
        default: 'Predefinito',
  ...
  settings: {
    ...
    cameraQualityAuto: 'Auto (Consigliato)',
    cameraQualityAutoResolved: 'Selezione automatica: {{resolved}} in base all\'hardware del server e al numero di stampanti.',
