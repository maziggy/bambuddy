export default {
  ...
  printers: {
    ...
    enclosure: {
      ...
      fanOn: 'ON',
      fanOff: 'OFF',
      noEntitiesHint: '请在打印机设置中配置 Home Assistant 传感器实体以显示读数。',
      noDataHint: '暂无数据 — 请检查 Home Assistant 是否已在设置 → 集成中配置。',
      haNotConfiguredWarning: 'Home Assistant 未配置。请前往设置 → 集成，先输入您的 HA 地址和令牌。',
      editLabel: '封闭式打印机',
      editDescription: '在打印机卡片上显示专用机箱区域，用于显示温度和湿度。',
      editEntitiesHint: '请输入机箱传感器的 Home Assistant 实体 ID，读数每 60 秒更新一次。',
      tempEntity: '温度实体',
      humidityEntity: '湿度实体',
      fanEntity: '风扇实体',
      historyTitle: '机箱历史记录',
      ...
      noReadings: '此时间范围内无读数记录。',
      readingsNote: 'BamBuddy 运行期间每 60 秒记录一次读数。',
      fanHistoryTitle: '机箱风扇历史记录',
      fanTotalRuntime: '总运行时间',
      fanRuns: '运行次数',
      fanAvgRun: '平均运行时长',
      fanLongestRun: '最长运行时长',
      fanNoActivity: '此时间范围内无风扇活动记录。',
      pollNote: 'BamBuddy 运行期间每 60 秒检查一次状态。',
    },
    progress: '{{percent}}% 完成',
    ...
    wled: {
      sectionTitle: 'WLED 灯带',
      sectionDescription: '连接 WLED 设备，将此打印机的状态以颜色显示在 LED 灯带上。',
      enabledLabel: '为此打印机启用 WLED',
      host: 'WLED 主机 / IP',
      hostPlaceholder: '192.168.1.50 或 wled.local',
      port: '端口',
      apiKey: 'API 密钥（可选）',
      apiKeyPlaceholder: '未设置则留空',
      testConnection: '测试连接',
      testEffect: '闪烁 LED',
      connected: '已连接',
      disconnected: '无法访问',
      deviceInfo: '{{name}} · WLED {{version}} · {{leds}} 个 LED',
    },
    // ROI editor
    roi: {
      title: '检测区域 (ROI)',
  ...
  storage: {
    title: '耗材存储',
    emptyState: '暂无存储单元。添加干燥机或干燥箱开始监控。',
    addUnit: '添加单元',
    editUnit: '编辑单元',
    deleteUnit: '删除单元',
    deleteConfirm: '删除"{{name}}"？所有历史数据也将被删除。',
    typeDryer: '干燥机',
    typeStorage: '干燥箱/存储',
    filterAll: '全部',
    filterDryers: '干燥机',
    ...
    humidity: '湿度',
    noReading: '暂无读数',
    noEntitiesHint: '未配置HA传感器实体 — 请在编辑中添加。',
    noDataHint: '实体已配置但暂无数据。HA轮询每60秒运行一次。',
    historyTitle: '传感器历史',
    history24h: '最近24小时',
    history48h: '最近48小时',
    history7d: '最近7天',
    noHistory: '所选时间段内无数据。',
    modalNameLabel: '名称',
    modalNamePlaceholder: '例如：Sunlu S1 Plus、干燥箱A',
    modalTypeLabel: '类型',
    modalTempEntityLabel: 'HA温度实体',
    modalTempEntityPlaceholder: 'sensor.dryer_temperature',
    modalHumidityEntityLabel: 'HA湿度实体',
    modalHumidityEntityPlaceholder: 'sensor.dryer_humidity',
    modalNotesLabel: '备注（可选）',
    modalNotesPlaceholder: '例如：70°C烘干PETG + PA',
    modalSave: '保存',
    modalCancel: '取消',
    savedToast: '存储单元已保存',
    deletedToast: '存储单元已删除',
  },
  ...
  settings: {
    ...
    // WLED
    wled: 'WLED',
    wledDescription: '通过控制 WLED 灯带来可视化打印机状态。每台打印机连接到各自的 WLED 设备，并显示下方全局状态映射中定义的颜色。',
    enableWled: '启用 WLED 集成',
    wledEnableDescription: '将打印机状态颜色发送到每台打印机的 WLED 设备',
    wledStateMapTitle: '状态颜色映射',
    wledStateMapDescription: '为每种打印机状态定义颜色、亮度和效果。所有打印机共享此映射。',
    wledStatePrinting: '打印中',
    wledStateIdle: '空闲',
    wledStateFinished: '已完成',
    wledStateError: '错误 / 失败',
    wledStatePaused: '已暂停',
    wledStatePreparing: '准备中',
    wledStateOffline: '离线 / 关闭',
    wledColour: '颜色',
    wledBrightness: '亮度',
    wledEffectId: '效果 ID',
    wledEffectIdHint: '0 = 纯色。请参阅 WLED 效果列表获取 ID。',
    wledPresetId: '预设 ID',
    wledPresetIdHint: '若设置，则激活此 WLED 预设而非颜色/效果。',
    wledPresetNone: '无（使用颜色）',
    // Smart Plugs
