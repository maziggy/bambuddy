export default {
  ...
  wled: {
    ...
    presetSegmentHint: 'Ön ayarı WLED içinde oluştururken hedef segmenti seçin ve “Checked segments only” seçeneğini etkinleştirin. Çalışma sırasında Bambuddy yalnızca yapılandırılmış ön ayarı etkinleştirir.',
