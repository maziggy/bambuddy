export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: 'Query the community Open Filament Database when a scanned barcode isn\'t already in your inventory. Turn off to only match barcodes you\'ve scanned before — scanning itself always keeps working.',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualInvalid: 'Enter a valid UPC-A, EAN-8, or EAN-13 barcode (8, 12, or 13 digits)',
      lookUp: 'Look Up',
