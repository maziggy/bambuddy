export default {
  ...
  virtualPrinter: {
    ...
    howItWorks: {
      title: 'How it works',
      intro: 'Each virtual printer appears in Bambu Studio / OrcaSlicer via SSDP discovery. Create multiple printers with different modes:',
      archiveDesc: '3MF files sent to this printer are saved directly to the archive.',
      reviewDesc: 'Files are held for review. You approve or discard each upload before archiving.',
      queueDesc: 'Files are archived and automatically added to the print queue (unassigned).',
      proxyDesc: 'Traffic is relayed to a real printer. Requires a dedicated IP per proxy (interface alias).',
    },
    status: {
