export default {
  ...
  settings: {
    ...
    sidebarOrderSetDefaultHint: 'Definir padrão aplica o menu conforme configurado a todos os novos usuários.',
    sidebarDefaultSet: 'Ordem padrão do menu definida para novos usuários.',
