  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMapping: 'Group Mapping (JSON)',
        groupMappingHint: 'Map identity provider groups to Bambuddy groups. Available groups:',
        ...
        groupMappingInvalidJson: 'Group mapping must be a JSON object like {"idp-group": "Bambuddy group"}.',
        groupMappingUnknownGroups: 'Unknown Bambuddy group(s): {{groups}}',
