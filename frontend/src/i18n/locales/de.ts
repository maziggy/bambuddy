export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: 'Fragt die Open Filament Database der Community ab, wenn ein gescannter Barcode noch nicht im eigenen Bestand ist. Deaktivieren, um nur bereits gescannte Barcodes abzugleichen — das Scannen selbst funktioniert immer.',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualInvalid: 'Geben Sie einen gültigen UPC-A-, EAN-8- oder EAN-13-Barcode ein (8, 12 oder 13 Ziffern)',
      lookUp: 'Nachschlagen',
