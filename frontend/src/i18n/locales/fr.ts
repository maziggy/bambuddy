export default {
  ...
  settings: {
    ...
    sidebarOrderSetDefaultHint: 'Définir par défaut applique le menu tel que configuré à tous les nouveaux utilisateurs.',
    sidebarDefaultSet: 'Ordre du menu par défaut défini pour les nouveaux utilisateurs.',
