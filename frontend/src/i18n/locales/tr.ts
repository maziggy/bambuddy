export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: 'Video işleme',
    cameraVideoProcessingSoftware: 'Yazılım işleme',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: 'H.264 kodunu çözmek ve MJPEG kodlamak için CPU kullanır.',
    cameraVideoProcessingIntelQsvDescription: 'Donanımsal H.264 kod çözme ve MJPEG kodlama için Intel Quick Sync kullanır. QSV/VAAPI destekli FFmpeg ve bir DRM işleme aygıtına erişim gerektirir.',
    ...
    qsvDiagnosticStageInitialization: 'Quick Sync başlatma',
    qsvDiagnosticFfmpegMissing: 'FFmpeg yüklü değil veya PATH üzerinden kullanılamıyor.',
    qsvDiagnosticDeviceMissing: 'Erişilebilir bir GPU işleme aygıtı bulunamadı. Intel GPU işleme aygıtını konteynere aktarın.',
    qsvDiagnosticPermissionDenied: 'Bambuddy GPU işleme aygıtına erişemiyor. render grubunu ve konteyner aygıt izinlerini kontrol edin.',
    qsvDiagnosticDecoderMissing: 'Bu FFmpeg derlemesinde h264_qsv kod çözücüsü bulunmuyor.',
    ...
    qsvDiagnosticRun: 'Uyumluluğu denetle',
    qsvDiagnosticRunning: 'Intel Quick Sync kullanılabilirliği denetleniyor...',
    qsvDiagnosticRequestFailed: 'Quick Sync tanılaması çalıştırılamadı.',
    qsvDiagnosticRetry: 'Yeniden denetle',
    qsvDiagnosticAvailable: 'Intel Quick Sync kullanılabilir',
    qsvDiagnosticUnavailable: 'Intel Quick Sync kullanılamıyor',
    qsvDiagnosticAvailableDescription: 'Intel GPU, FFmpeg codec bileşenleri ve donanım başlatma başarıyla denetlendi.',
    qsvDiagnosticHideDetails: 'Ayrıntıları gizle',
    qsvDiagnosticShowDetails: 'Ayrıntıları göster',
