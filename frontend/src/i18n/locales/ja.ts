export default {
  ...
  login: {
    ...
    twoFA: {
      title: '二要素認証',
      subtitle: 'アカウントは2FAで保護されています。以下に確認コードを入力してください。',
      methodAuthenticator: '認証アプリ',
      methodEmail: 'メールコード',
      methodBackup: 'バックアップコード',
      instructionsTotp: '認証アプリを開き、Bambuddyの6桁のコードを入力してください。',
      instructionsEmail: '6桁のコードがメールアドレスに送信されました。10分で期限切れになります。',
      instructionsEmailNotSent: '以下のボタンをクリックして、メールで確認コードを受け取ってください。',
      instructionsBackup: '8文字のバックアップコードのいずれかを入力してください。各コードは1回のみ使用できます。',
      sendCodeButton: 'メールでコードを送信',
      sendingCode: '送信中...',
      resendCode: 'コードを再送信',
      codeLabel: '確認コード',
