export default {
  ...
  settings: {
    ...
    keepBedWarmDesc: 'Plaka temizleme onayı beklenirken, yatağı bir sonraki öğenin hedef sıcaklığında tutarak hazneyi sıcak tutar. Yalnızca bir sonraki baskının hazne ısıtması gerektirmesi durumunda uygulanır (ASA, ABS, PA, PC vb.). Plaka temizleme onayının etkinleştirilmiş olması gerekir.',
