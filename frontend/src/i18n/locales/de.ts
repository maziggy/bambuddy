export default {
  ...
  settings: {
    ...
    keepBedWarmDesc: 'Während der Wartezeit auf die Druckplatten-Bestätigung wird das Heizbett auf der Zieltemperatur des nächsten Auftrags gehalten, sodass die Kammer warm bleibt. Gilt nur, wenn der nächste Druck Kammerwärme benötigt (ASA, ABS, PA, PC usw.). Erfordert aktivierte Druckplatten-Bestätigung.',
