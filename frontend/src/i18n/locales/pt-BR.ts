export default {
  ...
  settings: {
    ...
    lockSidebarOrder: 'Bloquear ordem',
    unlockSidebarOrder: 'Desbloquear ordem',
    sidebarOrderLocked: 'Ordem da barra lateral bloqueada para todos os usuários.',
    sidebarOrderUnlocked: 'Ordem da barra lateral desbloqueada. Os usuários podem personalizar sua ordem.',
    sidebarOrderLockFailed: 'Falha ao bloquear a ordem da barra lateral.',
    sidebarOrderUnlockFailed: 'Falha ao desbloquear a ordem da barra lateral.',
    reset: 'Redefinir',
