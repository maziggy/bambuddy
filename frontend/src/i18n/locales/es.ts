export default {
  ...
  printers: {
    ...
    enclosure: {
      sectionTitle: 'Recinto',
      temperature: 'Temperatura',
      humidity: 'Humedad',
      fan: 'Ventilador del recinto',
      fanOn: 'ON',
      fanOff: 'OFF',
      noEntitiesHint: 'Configure las entidades de sensor de Home Assistant en los ajustes de la impresora para mostrar las lecturas.',
      noDataHint: 'Sin datos aún — compruebe que Home Assistant esté configurado en Ajustes → Integraciones.',
      haNotConfiguredWarning: 'Home Assistant no está configurado. Vaya a Ajustes → Integraciones e introduzca primero su URL de HA y el token.',
      editLabel: 'Impresora con recinto cerrado',
      editDescription: 'Muestra una sección de recinto dedicada en la tarjeta de la impresora para temperatura y humedad.',
      editEntitiesHint: 'Introduzca los ID de entidad de Home Assistant para los sensores del recinto. Las lecturas se actualizan cada 60 segundos.',
      tempEntity: 'Entidad de temperatura',
      humidityEntity: 'Entidad de humedad',
      fanEntity: 'Entidad de ventilador',
      historyTitle: 'Historial del recinto',
      currentTemp: 'Temp. actual',
      currentHumidity: 'Humedad actual',
      minMax: 'Mín / Máx',
      tempChartLabel: 'Temperatura ({{unit}})',
      humidityChartLabel: 'Humedad ({{unit}})',
      noReadings: 'No se han registrado lecturas en este intervalo de tiempo.',
      readingsNote: 'Las lecturas se registran cada 60 segundos mientras BamBuddy está en ejecución.',
      fanHistoryTitle: 'Historial del ventilador del recinto',
      fanTotalRuntime: 'Tiempo de funcionamiento total',
      fanRuns: 'Ciclos',
      fanAvgRun: 'Ciclo promedio',
      fanLongestRun: 'Ciclo más largo',
      fanNoActivity: 'No se ha registrado actividad del ventilador en este intervalo de tiempo.',
      pollNote: 'El estado se comprueba cada 60 segundos mientras BamBuddy está en ejecución.',
    },
    ...
    wled: {
      sectionTitle: 'Tira LED WLED',
      sectionDescription: 'Conecte un dispositivo WLED para mostrar el estado de esta impresora como un color en una tira LED.',
      enabledLabel: 'Activar WLED para esta impresora',
      host: 'Host / IP de WLED',
      hostPlaceholder: '192.168.1.50 o wled.local',
      port: 'Puerto',
      apiKey: 'Clave API (opcional)',
      apiKeyPlaceholder: 'Dejar vacío si no está configurada',
      testConnection: 'Probar conexión',
      testEffect: 'Parpadear LED',
      connected: 'Conectado',
      disconnected: 'Inaccesible',
  ...
  storage: {
    title: 'Almacenamiento de Filamento',
    emptyState: 'Sin unidades aún. Añade un secador o caja seca para empezar.',
    addUnit: 'Añadir Unidad',
    editUnit: 'Editar Unidad',
    deleteUnit: 'Eliminar Unidad',
    deleteConfirm: '¿Eliminar "{{name}}"? También se eliminarán todas las lecturas históricas.',
    typeDryer: 'Secador',
    typeStorage: 'Caja Seca / Almacenamiento',
    filterAll: 'Todos',
    filterDryers: 'Secadores',
    filterStorage: 'Cajas Secas',
    temperature: 'Temperatura',
    humidity: 'Humedad',
    noReading: 'Sin lectura aún',
    noEntitiesHint: 'Sin entidades de sensor HA — añádelas en Editar.',
    noDataHint: 'Entidades configuradas pero sin datos. Sondeo HA cada 60 s.',
    historyTitle: 'Historial del Sensor',
    history24h: 'Últimas 24 h',
    history48h: 'Últimas 48 h',
    history7d: 'Últimos 7 días',
    noHistory: 'Sin lecturas en el período seleccionado.',
    modalNameLabel: 'Nombre',
    modalNamePlaceholder: 'ej. Sunlu S1 Plus, Caja Seca A',
    modalTypeLabel: 'Tipo',
    modalTempEntityLabel: 'Entidad de Temperatura HA',
    modalTempEntityPlaceholder: 'sensor.secador_temperatura',
    modalHumidityEntityLabel: 'Entidad de Humedad HA',
    modalHumidityEntityPlaceholder: 'sensor.secador_humedad',
    modalNotesLabel: 'Notas (opcional)',
    modalNotesPlaceholder: 'ej. Secando PETG + PA a 70 °C',
    modalSave: 'Guardar',
    modalCancel: 'Cancelar',
    savedToast: 'Unidad de almacenamiento guardada',
    deletedToast: 'Unidad de almacenamiento eliminada',
  },
  ...
  settings: {
    ...
    // WLED
    wled: 'WLED',
    wledDescription: 'Controle tiras LED WLED para visualizar el estado de la impresora. Cada impresora se conecta a su propio dispositivo WLED y muestra el color definido en el mapa de estados global a continuación.',
    enableWled: 'Activar integración WLED',
    wledEnableDescription: 'Enviar colores de estado de la impresora a los dispositivos WLED de cada impresora',
    wledStateMapTitle: 'Mapa de colores de estado',
    wledStateMapDescription: 'Define el color, el brillo y el efecto para cada estado de la impresora. Todas las impresoras comparten este mapa.',
    wledStatePrinting: 'Imprimiendo',
    wledStateIdle: 'En espera',
    wledStateFinished: 'Finalizado',
    wledStateError: 'Error / Fallido',
    wledStatePaused: 'En pausa',
    wledStatePreparing: 'Preparando',
    wledStateOffline: 'Desconectado / Apagado',
    wledColour: 'Color',
    wledBrightness: 'Brillo',
    wledEffectId: 'ID de efecto',
    wledEffectIdHint: '0 = Sólido. Consulte la lista de efectos WLED para los ID.',
    wledPresetId: 'ID de ajuste preestablecido',
    wledPresetIdHint: 'Si se establece, activa este ajuste preestablecido de WLED en lugar de color/efecto.',
    wledPresetNone: 'Ninguno (usar color)',
    // Smart Plugs
