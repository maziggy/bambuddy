export default {
  ...
  login: {
    ...
    twoFA: {
      title: '双因素认证',
      subtitle: '您的账户受2FA保护。请在下方输入验证码。',
      methodAuthenticator: '验证器应用',
      methodEmail: '邮件验证码',
      methodBackup: '备用验证码',
      instructionsTotp: '打开您的验证器应用，输入Bambuddy的6位验证码。',
      instructionsEmail: '6位验证码已发送至您的邮箱。10分钟内有效。',
      instructionsEmailNotSent: '点击下方按钮，通过邮件接收验证码。',
      instructionsBackup: '输入您的8位备用验证码之一。每个验证码只能使用一次。',
      sendCodeButton: '通过邮件发送验证码',
      sendingCode: '发送中...',
      resendCode: '重新发送验证码',
      codeLabel: '验证码',
      backupCodeLabel: '备用验证码',
