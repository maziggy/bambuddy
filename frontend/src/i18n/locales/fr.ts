export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: "Interroge l'Open Filament Database communautaire lorsqu'un code-barres scanné n'est pas déjà dans votre inventaire. Désactivez pour ne faire correspondre que les codes-barres déjà scannés — le scan lui-même continue toujours de fonctionner.",
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualInvalid: 'Saisissez un code-barres UPC-A, EAN-8 ou EAN-13 valide (8, 12 ou 13 chiffres)',
      lookUp: 'Rechercher',
