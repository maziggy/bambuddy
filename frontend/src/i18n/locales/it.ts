export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: "Interroga l'Open Filament Database della community quando un codice a barre scansionato non è già nel tuo inventario. Disattiva per abbinare solo i codici a barre già scansionati in precedenza — la scansione in sé continua sempre a funzionare.",
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualInvalid: 'Inserisci un codice a barre UPC-A, EAN-8 o EAN-13 valido (8, 12 o 13 cifre)',
      lookUp: 'Cerca',
