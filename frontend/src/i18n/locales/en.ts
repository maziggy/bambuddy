export default {
  ...
  printers: {
    ...
    fullCalibration: {
      label: 'Calibration',
      description: 'Choose the calibration stages supported by this printer.',
      confirmTitle: 'Start calibration?',
      confirmWarning: 'The printer will move the bed and toolhead and may produce loud vibration noises. Make sure the build plate is installed correctly and the printer area is clear. Calibration can take several minutes.',
      start: 'Start Calibration',
      starting: 'Starting calibration…',
      commandSent: 'Calibration command sent.',
      inProgress: 'Calibration in progress',
      printerMustBeIdle: 'Printer must be idle or finished',
      alreadyCalibrating: 'Printer is already calibrating',
      unsupported: 'Calibration unsupported',
      failed: 'Failed to start calibration',
      stageSelection: 'Calibration stages',
      plateClearConfirmation: 'I confirm the build plate is clear and ready for calibration.',
      stages: {
        bed_leveling: 'Bed leveling',
        vibration_compensation: 'Vibration compensation',
        motor_noise_cancellation: 'Motor noise cancellation',
        nozzle_offset: 'Nozzle offset calibration',
        high_temperature_bed: 'High-temperature bed calibration',
        nozzle_clump_detection: 'Nozzle clump detection calibration',
      },
      errors: {
        printer_disconnected: 'Printer is not connected',
        printer_not_idle: 'Printer must be idle or finished before starting calibration',
        calibration_already_running: 'Printer is already calibrating',
        calibration_unsupported: 'Calibration unsupported for this printer model',
        calibration_delivery_failed: 'Failed to start calibration',
        plate_clear_confirmation_required: 'Confirm the build plate is clear before calibrating after a finished print',
        invalid_calibration_selection: 'Select supported calibration stages',
      },
    },
    // Plate detection
    plateDetection: {
