  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMappingHint: 'Gruppen des Identitätsanbieters auf Bambuddy-Gruppen abbilden. Verfügbare Gruppen:',
        ...
        groupMappingInvalidJson: 'Das Gruppen-Mapping muss ein JSON-Objekt sein, z. B. {"idp-gruppe": "Bambuddy-Gruppe"}.',
        groupMappingUnknownGroups: 'Unbekannte Bambuddy-Gruppe(n): {{groups}}',
