export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: 'ビデオ処理',
    cameraVideoProcessingSoftware: 'ソフトウェア処理',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: 'CPU を使用して H.264 をデコードし、MJPEG をエンコードします。',
    cameraVideoProcessingIntelQsvDescription: 'Intel Quick Sync を使用して H.264 のハードウェアデコードと MJPEG のエンコードを行います。QSV/VAAPI 対応の FFmpeg と DRM レンダーデバイスへのアクセスが必要です。',
    ...
    qsvDiagnosticStageInitialization: 'Quick Sync の初期化',
    qsvDiagnosticFfmpegMissing: 'FFmpeg がインストールされていないか、PATH から利用できません。',
    qsvDiagnosticDeviceMissing: 'アクセス可能な GPU レンダーデバイスが見つかりません。Intel GPU のレンダーデバイスをコンテナに渡してください。',
    qsvDiagnosticPermissionDenied: 'Bambuddy が GPU レンダーデバイスにアクセスできません。render グループとコンテナのデバイス権限を確認してください。',
    qsvDiagnosticDecoderMissing: 'この FFmpeg ビルドには h264_qsv デコーダーが含まれていません。',
    qsvDiagnosticEncoderMissing: 'この FFmpeg ビルドには mjpeg_qsv エンコーダーが含まれていません。',
    qsvDiagnosticCodecsMissing: 'この FFmpeg ビルドには必要な QSV コーデックが含まれていません。',
    qsvDiagnosticInitializationFailed: 'Intel GPU は検出されましたが、Quick Sync を初期化できませんでした。Intel Media ドライバーと oneVPL ランタイムを確認してください。',
    qsvDiagnosticTimeout: 'Quick Sync 診断がタイムアウトしました。',
    qsvDiagnosticUnknownFailure: 'Quick Sync は利用できません。下の詳細を開いて診断情報を確認してください。',
    qsvDiagnosticManualDescription: 'Intel Quick Sync を使用する前に互換性チェックを実行してください。',
    qsvDiagnosticRun: '互換性を確認',
    qsvDiagnosticRunning: 'Intel Quick Sync の利用可否を確認しています...',
    qsvDiagnosticRequestFailed: 'Quick Sync 診断を実行できませんでした。',
    qsvDiagnosticRetry: 'もう一度確認',
    qsvDiagnosticAvailable: 'Intel Quick Sync を利用できます',
    qsvDiagnosticUnavailable: 'Intel Quick Sync を利用できません',
    qsvDiagnosticAvailableDescription: 'Intel GPU、FFmpeg コーデック、ハードウェア初期化の確認に成功しました。',
    qsvDiagnosticHideDetails: '詳細を隠す',
    qsvDiagnosticShowDetails: '詳細を表示',
