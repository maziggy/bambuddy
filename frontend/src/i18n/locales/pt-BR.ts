export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: 'Atribuir por QR',
      title: 'Escolher destino da atribuição',
      description: 'Escolha um destino e depois escaneie o QR de um carretel para atribuí-lo ali.',
      tabAms: 'Slot AMS',
      ...
      scanInstruction: 'Aponte a câmera para o QR code da etiqueta de um carretel.',
      scanningTarget: 'Destino: {{location}}',
      back: 'Voltar',
      invalidQr: 'Esse QR code não é uma etiqueta de carretel.',
      cameraDenied: 'O acesso à câmera foi negado. Permita a câmera e tente novamente.',
      cameraInsecure: 'A câmera precisa de uma conexão segura (HTTPS).',
      cameraNoDevice: 'Nenhuma câmera foi encontrada neste dispositivo.',
      assignSuccess: 'Atribuído a {{location}}',
      storageSuccess: 'Movido para {{location}}',
      assignFailed: 'Não foi possível atribuir a {{location}}',
    },
