export default {
  ...
  printers: {
    ...
    partRemoval: {
      ...
      pausedForRemoval: 'Processing: {{jobName}} - Paused for Previous Part Removal Confirmation',
      onDeckPausedForRemoval: 'Processing: {{jobName}} - Paused for Previous Part Removal Confirmation',
