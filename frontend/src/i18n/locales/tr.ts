export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: 'Taranan bir barkod envanterinizde henüz yoksa topluluğun Open Filament Database\'ini sorgular. Yalnızca daha önce taranmış barkodlarla eşleştirmek için kapatın — taramanın kendisi her zaman çalışmaya devam eder.',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualInvalid: 'Geçerli bir UPC-A, EAN-8 veya EAN-13 barkodu girin (8, 12 veya 13 hane)',
      lookUp: 'Ara',
