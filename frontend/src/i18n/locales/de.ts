export default {
  ...
  printers: {
    ...
    partRemoval: {
      ...
      pausedForRemoval: 'Verarbeitung: {{jobName}} - Pausiert für vorherige Teileentnahme-Bestätigung',
      onDeckPausedForRemoval: 'Verarbeitung: {{jobName}} - Pausiert für vorherige Teileentnahme-Bestätigung',
