export default {
  ...
  printers: {
    ...
    enclosure: {
      ...
      fanOn: 'ON',
      fanOff: 'OFF',
      noEntitiesHint: '請在印表機設定中配置 Home Assistant 感測器實體以顯示讀數。',
      noDataHint: '尚無資料 — 請確認 Home Assistant 已在設定 → 整合中完成設定。',
      haNotConfiguredWarning: 'Home Assistant 未設定。請前往設定 → 整合，先輸入您的 HA 網址和權杖。',
      editLabel: '封閉式印表機',
      editDescription: '在印表機卡片上顯示專用機箱區域，用於顯示溫度和濕度。',
      editEntitiesHint: '請輸入機箱感測器的 Home Assistant 實體 ID，讀數每 60 秒更新一次。',
      tempEntity: '溫度實體',
      humidityEntity: '濕度實體',
      fanEntity: '風扇實體',
      historyTitle: '機箱歷史記錄',
      currentTemp: '目前溫度',
      currentHumidity: '目前濕度',
      minMax: '最小 / 最大',
      tempChartLabel: '溫度 ({{unit}})',
      humidityChartLabel: '濕度 ({{unit}})',
      noReadings: '此時間範圍內無讀數記錄。',
      readingsNote: 'BamBuddy 執行期間每 60 秒記錄一次讀數。',
      fanHistoryTitle: '機箱風扇歷史記錄',
      fanTotalRuntime: '總執行時間',
      fanRuns: '執行次數',
      fanAvgRun: '平均執行時長',
      fanLongestRun: '最長執行時長',
      fanNoActivity: '此時間範圍內無風扇活動記錄。',
      pollNote: 'BamBuddy 執行期間每 60 秒檢查一次狀態。',
    },
    progress: '{{percent}}% 完成',
    ...
    wled: {
      sectionTitle: 'WLED 燈條',
      sectionDescription: '連線 WLED 裝置，將此印表機的狀態以顏色顯示在 LED 燈條上。',
      enabledLabel: '為此印表機啟用 WLED',
      host: 'WLED 主機 / IP',
      hostPlaceholder: '192.168.1.50 或 wled.local',
      port: '連接埠',
      apiKey: 'API 金鑰（選用）',
      apiKeyPlaceholder: '未設定則留空',
      testConnection: '測試連線',
      testEffect: '閃爍 LED',
      connected: '已連線',
      disconnected: '無法存取',
      deviceInfo: '{{name}} · WLED {{version}} · {{leds}} 個 LED',
    },
    // ROI editor
    roi: {
      title: '檢測區域 (ROI)',
  ...
  storage: {
    title: '耗材儲存',
    emptyState: '尚無儲存單元。新增乾燥機或乾燥箱以開始監控。',
    addUnit: '新增單元',
    editUnit: '編輯單元',
    deleteUnit: '刪除單元',
    deleteConfirm: '刪除「{{name}}」？所有歷史數據也將被刪除。',
    typeDryer: '乾燥機',
    typeStorage: '乾燥箱/儲存',
    filterAll: '全部',
    filterDryers: '乾燥機',
    ...
    humidity: '濕度',
    noReading: '尚無讀數',
    noEntitiesHint: '未設定HA感測器實體 — 請在編輯中新增。',
    noDataHint: '實體已設定但尚無數據。HA輪詢每60秒執行一次。',
    historyTitle: '感測器歷史',
    history24h: '最近24小時',
    history48h: '最近48小時',
    history7d: '最近7天',
    noHistory: '所選時間段內無數據。',
    modalNameLabel: '名稱',
    modalNamePlaceholder: '例如：Sunlu S1 Plus、乾燥箱A',
    modalTypeLabel: '類型',
    modalTempEntityLabel: 'HA溫度實體',
    modalTempEntityPlaceholder: 'sensor.dryer_temperature',
    modalHumidityEntityLabel: 'HA濕度實體',
    modalHumidityEntityPlaceholder: 'sensor.dryer_humidity',
    modalNotesLabel: '備註（可選）',
    modalNotesPlaceholder: '例如：70°C烘乾PETG + PA',
    modalSave: '儲存',
    modalCancel: '取消',
    savedToast: '儲存單元已儲存',
    deletedToast: '儲存單元已刪除',
  },
  ...
  settings: {
    ...
    // WLED
    wled: 'WLED',
    wledDescription: '透過控制 WLED 燈條來視覺化印表機狀態。每台印表機連線到各自的 WLED 裝置，並顯示下方全域狀態對應中定義的顏色。',
    enableWled: '啟用 WLED 整合',
    wledEnableDescription: '將印表機狀態顏色傳送到每台印表機的 WLED 裝置',
    wledStateMapTitle: '狀態顏色對應',
    wledStateMapDescription: '為每種印表機狀態定義顏色、亮度和效果。所有印表機共享此對應。',
    wledStatePrinting: '列印中',
    wledStateIdle: '閒置',
    wledStateFinished: '已完成',
    wledStateError: '錯誤 / 失敗',
    wledStatePaused: '已暫停',
    wledStatePreparing: '準備中',
    wledStateOffline: '離線 / 關閉',
    wledColour: '顏色',
    wledBrightness: '亮度',
    wledEffectId: '效果 ID',
    wledEffectIdHint: '0 = 純色。請參閱 WLED 效果清單取得 ID。',
    wledPresetId: '預設 ID',
    wledPresetIdHint: '若設定，則啟用此 WLED 預設而非顏色/效果。',
    wledPresetNone: '無（使用顏色）',
    // Smart Plugs
