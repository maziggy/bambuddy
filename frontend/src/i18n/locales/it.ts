export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: 'Assegna tramite QR',
      title: 'Scegli la destinazione di assegnazione',
      description: 'Scegli una destinazione, poi scansiona il QR di una bobina per assegnarla lì.',
      tabAms: 'Slot AMS',
      ...
      scanInstruction: 'Inquadra con la fotocamera il codice QR dell’etichetta di una bobina.',
      scanningTarget: 'Destinazione: {{location}}',
      back: 'Indietro',
      invalidQr: 'Questo codice QR non è un’etichetta di bobina.',
      cameraDenied: 'Accesso alla fotocamera negato. Consenti l’autorizzazione e riprova.',
      cameraInsecure: 'La fotocamera richiede una connessione sicura (HTTPS).',
      cameraNoDevice: 'Nessuna fotocamera trovata su questo dispositivo.',
      assignSuccess: 'Assegnata a {{location}}',
      storageSuccess: 'Spostata in {{location}}',
      assignFailed: 'Impossibile assegnare a {{location}}',
    },
