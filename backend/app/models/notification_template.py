...
DEFAULT_TEMPLATES = [
    {
        ...
        "body_template": "{printer_alias}: {filename}\nEstimated: {estimated_time}",
    },
    {
    ...
    },
    {
        ...
        "body_template": "{printer_alias}: print started with missing spool assignments\nSlots: {missing_slots}\nExpected profile:\n{missing_slot_details}",
    },
    {
    ...
    },
    {
        ...
        "body_template": "{printer_alias} {ams_label}: Humidity {humidity}% exceeds {threshold}% threshold",
    },
    {
        "event_type": "ams_temperature_high",
        "name": "AMS Temperature High",
        "title_template": "AMS Temperature Alert",
        "body_template": "{printer_alias} {ams_label}: Temperature {temperature}°C exceeds {threshold}°C threshold",
    },
    {
        ...
        "body_template": (
            "{printer_alias} {ams_label}: stopped automatic drying after {cycles} cycles left humidity at "
    ...
    },
    {
        ...
        "body_template": "{printer_alias}: Bed cooled to {bed_temp}°C (threshold: {threshold}°C)",
    },
    {
        "event_type": "ha_sensor_alert",
        "name": "Printer Sensor Alert",
        "title_template": "Sensor Alert",
        "body_template": "{printer_alias}: {sensor} is {state}",
    },
    {
    ...
    },
    {
        ...
        "body_template": "{job_name} assigned to {printer_alias} (from Any {target_model} queue)",
    },
    {
        "event_type": "queue_job_started",
        "name": "Queue Job Started",
        "title_template": "Queue Job Started",
        "body_template": "{printer_alias}: {job_name}\nEstimated: {estimated_time}",
    },
    {
