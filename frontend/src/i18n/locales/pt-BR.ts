  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMapping: 'Mapeamento de grupos (JSON)',
        groupMappingHint: 'Mapeia grupos do provedor de identidade para grupos do Bambuddy. Grupos disponíveis:',
        ...
        groupMappingInvalidJson: 'O mapeamento de grupos deve ser um objeto JSON como {"grupo-idp": "grupo-bambuddy"}.',
        groupMappingUnknownGroups: 'Grupo(s) Bambuddy desconhecido(s): {{groups}}',
