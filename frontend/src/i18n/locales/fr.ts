export default {
  ...
  settings: {
    ...
    keepBedWarmDesc: 'En attendant la confirmation de plateau libéré, maintient le lit chauffant à la température cible de l\'élément suivant pour que la chambre reste chaude. S\'applique uniquement lorsque l\'impression suivante nécessite un chauffage de chambre (ASA, ABS, PA, PC, etc.). Nécessite l\'activation de la confirmation de plateau libéré.',
