export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: '透過 QR 碼指派',
      title: '選擇指派目標',
      description: '先選擇目標，然後掃描耗材 QR 碼即可將其指派到該處。',
      tabAms: 'AMS 插槽',
      tabStorage: '儲存',
      printer: '印表機',
      selectSlot: '選擇一個插槽',
      ...
      startScan: '設定目標並掃描',
      scanTitle: '掃描耗材 QR 碼',
      scanInstruction: '將相機對準耗材標籤上的 QR 碼。',
      scanningTarget: '目標：{{location}}',
      back: '返回',
      invalidQr: '此 QR 碼不是耗材標籤。',
      cameraDenied: '相機存取遭拒。請允許相機權限後再試一次。',
      cameraInsecure: '相機需要安全（HTTPS）連線。',
      cameraNoDevice: '在此裝置上找不到相機。',
      assignSuccess: '已指派到 {{location}}',
      storageSuccess: '已移動到 {{location}}',
      assignFailed: '無法指派到 {{location}}',
    },
    spoolArchived: '耗材已歸檔',
    spoolRestored: '耗材已恢復',
