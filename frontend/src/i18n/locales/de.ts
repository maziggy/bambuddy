export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: 'Videoverarbeitung',
    cameraVideoProcessingSoftware: 'Softwareverarbeitung',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: 'Verwendet die CPU zum Dekodieren von H.264 und Kodieren von MJPEG.',
    cameraVideoProcessingIntelQsvDescription: 'Verwendet Intel Quick Sync zur hardwarebeschleunigten H.264-Dekodierung und MJPEG-Kodierung. Erfordert FFmpeg mit QSV/VAAPI-Unterstützung und Zugriff auf ein DRM-Rendergerät.',
    cameraVideoProcessingReconnectDescription: 'Änderungen werden wirksam, nachdem der aktuelle gemeinsam genutzte Kamerastream beendet und neu verbunden wurde.',
    qsvDiagnosticStageFfmpeg: 'FFmpeg',
    qsvDiagnosticStageDevice: 'Intel-GPU-Gerät',
    qsvDiagnosticStageCodecs: 'Erforderliche QSV-Codecs',
    qsvDiagnosticStageInitialization: 'Quick-Sync-Initialisierung',
    qsvDiagnosticFfmpegMissing: 'FFmpeg ist nicht installiert oder nicht über PATH verfügbar.',
    qsvDiagnosticDeviceMissing: 'Es wurde kein zugängliches GPU-Rendergerät gefunden. Reiche das Rendergerät der Intel-GPU in den Container durch.',
    qsvDiagnosticPermissionDenied: 'Bambuddy kann nicht auf das GPU-Rendergerät zugreifen. Prüfe die render-Gruppe und die Geräteberechtigungen des Containers.',
    qsvDiagnosticDecoderMissing: 'Diese FFmpeg-Version enthält den Decoder h264_qsv nicht.',
    qsvDiagnosticEncoderMissing: 'Diese FFmpeg-Version enthält den Encoder mjpeg_qsv nicht.',
    qsvDiagnosticCodecsMissing: 'Diese FFmpeg-Version enthält nicht alle erforderlichen QSV-Codecs.',
    qsvDiagnosticInitializationFailed: 'Die Intel-GPU wurde gefunden, Quick Sync konnte jedoch nicht initialisiert werden. Prüfe den Intel-Media-Treiber und die oneVPL-Laufzeit.',
    ...
    qsvDiagnosticTimeout: 'Die Quick-Sync-Diagnose hat das Zeitlimit überschritten.',
    qsvDiagnosticUnknownFailure: 'Quick Sync ist nicht verfügbar. Öffne unten die Details für Diagnoseinformationen.',
    qsvDiagnosticManualDescription: 'Führe vor der Verwendung von Intel Quick Sync eine Kompatibilitätsprüfung aus.',
    qsvDiagnosticRun: 'Kompatibilität prüfen',
    qsvDiagnosticRunning: 'Verfügbarkeit von Intel Quick Sync wird geprüft...',
    qsvDiagnosticRequestFailed: 'Die Quick-Sync-Diagnose konnte nicht ausgeführt werden.',
    qsvDiagnosticRetry: 'Erneut prüfen',
    qsvDiagnosticAvailable: 'Intel Quick Sync ist verfügbar',
    qsvDiagnosticUnavailable: 'Intel Quick Sync ist nicht verfügbar',
    qsvDiagnosticAvailableDescription: 'Intel-GPU, FFmpeg-Codecs und Hardwareinitialisierung wurden erfolgreich geprüft.',
    qsvDiagnosticHideDetails: 'Details ausblenden',
    qsvDiagnosticShowDetails: 'Details anzeigen',
