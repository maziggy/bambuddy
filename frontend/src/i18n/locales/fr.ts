export default {
  ...
  printers: {
    ...
    enclosure: {
      sectionTitle: 'Boîtier',
      temperature: 'Température',
      humidity: 'Humidité',
      fan: 'Ventilateur du boîtier',
      fanOn: 'ON',
      fanOff: 'OFF',
      noEntitiesHint: 'Configurez les entités de capteurs Home Assistant dans les paramètres de l\'imprimante pour afficher les relevés.',
      noDataHint: 'Pas encore de données — vérifiez que Home Assistant est configuré dans Paramètres → Intégrations.',
      haNotConfiguredWarning: 'Home Assistant n\'est pas configuré. Allez dans Paramètres → Intégrations et saisissez d\'abord votre URL HA et votre jeton.',
      editLabel: 'Imprimante fermée',
      editDescription: 'Affiche une section boîtier dédiée sur la carte imprimante pour la température et l\'humidité.',
      editEntitiesHint: 'Saisissez les identifiants d\'entité Home Assistant pour vos capteurs de boîtier. Les relevés se mettent à jour toutes les 60 secondes.',
      tempEntity: 'Entité température',
      humidityEntity: 'Entité humidité',
      fanEntity: 'Entité ventilateur',
      historyTitle: 'Historique du boîtier',
      currentTemp: 'Temp. actuelle',
      currentHumidity: 'Humidité actuelle',
      minMax: 'Min / Max',
      tempChartLabel: 'Température ({{unit}})',
      humidityChartLabel: 'Humidité ({{unit}})',
      noReadings: 'Aucun relevé enregistré sur cette plage horaire.',
      readingsNote: 'Les relevés sont enregistrés toutes les 60 secondes pendant que BamBuddy est en cours d\'exécution.',
      fanHistoryTitle: 'Historique du ventilateur du boîtier',
      fanTotalRuntime: 'Durée totale de fonctionnement',
      fanRuns: 'Cycles',
      fanAvgRun: 'Durée moy. de cycle',
      fanLongestRun: 'Cycle le plus long',
      fanNoActivity: 'Aucune activité du ventilateur enregistrée sur cette plage horaire.',
      pollNote: 'L\'état est vérifié toutes les 60 secondes pendant que BamBuddy est en cours d\'exécution.',
    },
    ...
    // WLED per-printer config
    wled: {
      sectionTitle: 'Bandeau LED WLED',
      sectionDescription: 'Connectez un appareil WLED pour afficher l\'état de cette imprimante comme une couleur sur un bandeau LED.',
      enabledLabel: 'Activer WLED pour cette imprimante',
      host: 'Hôte / IP WLED',
      hostPlaceholder: '192.168.1.50 ou wled.local',
      port: 'Port',
      apiKey: 'Clé API (facultatif)',
      apiKeyPlaceholder: 'Laisser vide si non définie',
      testConnection: 'Tester la connexion',
      testEffect: 'Faire clignoter le LED',
      connected: 'Connecté',
      disconnected: 'Inaccessible',
      deviceInfo: '{{name}} · WLED {{version}} · {{leds}} LEDs',
    },
    // ROI editor
    roi: {
  ...
  storage: {
    title: 'Stockage de Filament',
    emptyState: "Aucune unité. Ajoutez un séchoir ou une boîte sèche pour commencer.",
    addUnit: 'Ajouter une unité',
    editUnit: "Modifier l'unité",
    deleteUnit: "Supprimer l'unité",
    deleteConfirm: 'Supprimer "{{name}}" ? Toutes les lectures seront supprimées.',
    typeDryer: 'Séchoir',
    typeStorage: 'Boîte sèche / Stockage',
    filterAll: 'Tous',
    filterDryers: 'Séchoirs',
    filterStorage: 'Boîtes sèches',
    temperature: 'Température',
    humidity: 'Humidité',
    noReading: 'Pas encore de lecture',
    noEntitiesHint: 'Aucune entité capteur HA — ajoutez-les dans Modifier.',
    noDataHint: 'Entités configurées mais pas de données. Sondage HA toutes les 60 s.',
    historyTitle: 'Historique du capteur',
    history24h: 'Dernières 24 h',
    history48h: 'Dernières 48 h',
    history7d: 'Derniers 7 jours',
    noHistory: 'Aucune lecture dans la période sélectionnée.',
    modalNameLabel: 'Nom',
    modalNamePlaceholder: 'ex. Sunlu S1 Plus, Boîte sèche A',
    modalTypeLabel: 'Type',
    modalTempEntityLabel: 'Entité température HA',
    modalTempEntityPlaceholder: 'sensor.sechoir_temperature',
    modalHumidityEntityLabel: 'Entité humidité HA',
    modalHumidityEntityPlaceholder: 'sensor.sechoir_humidite',
    modalNotesLabel: 'Notes (facultatif)',
    modalNotesPlaceholder: 'ex. Séchage PETG + PA à 70 °C',
    modalSave: 'Enregistrer',
    modalCancel: 'Annuler',
    savedToast: 'Unité de stockage enregistrée',
    deletedToast: 'Unité de stockage supprimée',
  },
  ...
  settings: {
    ...
    // WLED
    wled: 'WLED',
    wledDescription: 'Contrôlez des bandeaux LED WLED pour visualiser l\'état de l\'imprimante. Chaque imprimante se connecte à son propre appareil WLED et affiche la couleur définie dans la carte d\'état globale ci-dessous.',
    enableWled: 'Activer l\'intégration WLED',
    wledEnableDescription: 'Envoyer les couleurs d\'état de l\'imprimante aux appareils WLED par imprimante',
    wledStateMapTitle: 'Carte des couleurs d\'état',
    wledStateMapDescription: 'Définissez la couleur, la luminosité et l\'effet pour chaque état de l\'imprimante. Toutes les imprimantes partagent cette carte.',
    wledStatePrinting: 'En cours d\'impression',
    wledStateIdle: 'En veille',
    wledStateFinished: 'Terminé',
    wledStateError: 'Erreur / Échec',
    wledStatePaused: 'En pause',
    wledStatePreparing: 'Préparation',
    wledStateOffline: 'Hors ligne / Éteint',
    wledColour: 'Couleur',
    wledBrightness: 'Luminosité',
    wledEffectId: 'ID d\'effet',
    wledEffectIdHint: '0 = Uni. Voir la liste des effets WLED pour les identifiants.',
    wledPresetId: 'ID de préréglage',
    wledPresetIdHint: 'Si défini, active ce préréglage WLED à la place de la couleur/effet.',
    wledPresetNone: 'Aucun (utiliser la couleur)',
    // Smart Plugs
