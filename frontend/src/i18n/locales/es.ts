  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMapping: 'Mapeo de grupos (JSON)',
        groupMappingHint: 'Mapear grupos del proveedor de identidad a grupos de Bambuddy. Grupos disponibles:',
        ...
        groupMappingInvalidJson: 'El mapeo de grupos debe ser un objeto JSON como {"grupo-idp": "grupo-bambuddy"}.',
        groupMappingUnknownGroups: 'Grupo(s) de Bambuddy desconocido(s): {{groups}}',
