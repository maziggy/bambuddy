const ko = {
  ...
  "archives": {
    ...
    "platePicker": {
      ...
      "noGcode": "이 아카이브에는 미리볼 슬라이싱된 G코드가 없습니다. Bambu Studio에서 먼저 슬라이싱하세요."
    },
    "card": {
  ...
  "slice": {
    ...
    "printerMismatch": "이 3MF는 {{source}}용으로 슬라이싱되었지만 {{target}}을(를) 선택했습니다. 슬라이서 CLI는 다른 프린터용으로 3MF를 재슬라이싱할 수 없습니다 — 소스를 Bambu Studio에서 열어 프린터를 변경하고 다시 내보내세요.",
  ...
  "inventory": {
    ...
    "labels": {
      ...
      "templates": {
        "ams": {
          "label": "AMS 홀더 (30 × 15 mm)",
          "hint": "페이지당 단일 라벨; 인기 있는 AMS 필라멘트 라벨 홀더에 맞음."
        },
        "box40x30": {
