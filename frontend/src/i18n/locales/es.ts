export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: 'Procesamiento de video',
    cameraVideoProcessingSoftware: 'Procesamiento por software',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: 'Utiliza la CPU para decodificar H.264 y codificar MJPEG.',
    cameraVideoProcessingIntelQsvDescription: 'Utiliza Intel Quick Sync para la decodificación por hardware de H.264 y la codificación MJPEG. Requiere FFmpeg con compatibilidad QSV/VAAPI y acceso a un dispositivo de renderizado DRM.',
    cameraVideoProcessingReconnectDescription: 'Los cambios se aplican cuando la transmisión compartida actual de la cámara se detiene y vuelve a conectarse.',
    qsvDiagnosticStageFfmpeg: 'FFmpeg',
    qsvDiagnosticStageDevice: 'Dispositivo GPU Intel',
    qsvDiagnosticStageCodecs: 'Códecs QSV necesarios',
    qsvDiagnosticStageInitialization: 'Inicialización de Quick Sync',
    qsvDiagnosticFfmpegMissing: 'FFmpeg no está instalado o no está disponible en PATH.',
    qsvDiagnosticDeviceMissing: 'No se encontró ningún dispositivo de renderizado GPU accesible. Pase el dispositivo de la GPU Intel al contenedor.',
    qsvDiagnosticPermissionDenied: 'Bambuddy no puede acceder al dispositivo de renderizado GPU. Compruebe el grupo render y los permisos del dispositivo en el contenedor.',
    qsvDiagnosticDecoderMissing: 'Esta compilación de FFmpeg no incluye el decodificador h264_qsv.',
    qsvDiagnosticEncoderMissing: 'Esta compilación de FFmpeg no incluye el codificador mjpeg_qsv.',
    qsvDiagnosticCodecsMissing: 'Esta compilación de FFmpeg no incluye los códecs QSV necesarios.',
    qsvDiagnosticInitializationFailed: 'Se encontró la GPU Intel, pero no se pudo inicializar Quick Sync. Compruebe el controlador Intel Media y el entorno de ejecución oneVPL.',
    qsvDiagnosticTimeout: 'La comprobación de Quick Sync agotó el tiempo de espera.',
    qsvDiagnosticUnknownFailure: 'Quick Sync no está disponible. Abra los detalles para consultar la información de diagnóstico.',
    qsvDiagnosticManualDescription: 'Ejecute una comprobación de compatibilidad antes de utilizar Intel Quick Sync.',
    qsvDiagnosticRun: 'Comprobar compatibilidad',
    qsvDiagnosticRunning: 'Comprobando la disponibilidad de Intel Quick Sync...',
    qsvDiagnosticRequestFailed: 'No se pudo ejecutar la comprobación de Quick Sync.',
    qsvDiagnosticRetry: 'Comprobar de nuevo',
    qsvDiagnosticAvailable: 'Intel Quick Sync está disponible',
    qsvDiagnosticUnavailable: 'Intel Quick Sync no está disponible',
    qsvDiagnosticAvailableDescription: 'La GPU Intel, los códecs de FFmpeg y la inicialización de hardware se comprobaron correctamente.',
    qsvDiagnosticHideDetails: 'Ocultar detalles',
    qsvDiagnosticShowDetails: 'Mostrar detalles',
