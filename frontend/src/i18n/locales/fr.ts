  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMappingHint: 'Associer les groupes du fournisseur d\'identité aux groupes Bambuddy. Groupes disponibles :',
        ...
        groupMappingInvalidJson: 'Le mappage des groupes doit être un objet JSON comme {"groupe-idp": "groupe-bambuddy"}.',
        groupMappingUnknownGroups: 'Groupe(s) Bambuddy inconnu(s) : {{groups}}',
