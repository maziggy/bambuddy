export default {
  ...
  plugins: {
    title: 'Plugins',
    description: 'Manage installed plugins. Enable or disable plugins and configure their settings.',
    loading: 'Loading plugins...',
    loadingSettings: 'Loading settings...',
    loadError: 'Failed to load plugins.',
    retry: 'Retry',
    none: 'No plugins installed',
    noneHint: 'Drop plugin directories into the plugins/ folder and restart, or use the Install button above.',
    ...
    notLoadedEnabled: 'Plugin is enabled but not yet loaded — restart Bambuddy to apply.',
    notLoadedDisabled: 'Plugin is disabled and not loaded.',
    openViewer: 'Open Viewer',
    installPlugin: 'Install Plugin',
    upload: {
      title: 'Install Plugin',
      dropzone: 'Drop a .zip file here, or click to browse',
      uploading: 'Analysing plugin...',
      installing: 'Installing...',
      install: 'Install',
      cancel: 'Cancel',
      alreadyInstalled: 'A plugin with this key is already installed and will be overwritten.',
      bambuddyDetected: 'Native Bambuddy plugin detected',
      octoprintDetected: 'OctoPrint plugin detected — will be converted',
      unknownType: 'Unknown plugin format',
      unknownHint: 'This file does not appear to be a Bambuddy or OctoPrint plugin.',
      supported: 'Converted features',
      unsupported: 'Not converted',
      notes: 'Conversion notes',
      convertedCode: 'Generated code',
      showCode: 'Show generated code',
      hideCode: 'Hide generated code',
    },
    toast: {
      enabled: 'Plugin enabled',
      disabled: 'Plugin disabled',
      restartRequired: 'Restart required for the change to take effect.',
      toggleFailed: 'Failed to update plugin status.',
      settingsSaved: 'Plugin settings saved.',
      settingsFailed: 'Failed to save plugin settings.',
      installed: 'Plugin installed — restart to load it.',
