export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: '视频处理',
    cameraVideoProcessingSoftware: '软件处理',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: '使用 CPU 解码 H.264 并编码 MJPEG。',
    cameraVideoProcessingIntelQsvDescription: '使用 Intel Quick Sync 进行硬件 H.264 解码和 MJPEG 编码。需要支持 QSV/VAAPI 的 FFmpeg，并能够访问 DRM 渲染设备。',
    cameraVideoProcessingReconnectDescription: '更改将在当前共享摄像头流停止并重新连接后生效。',
    qsvDiagnosticStageFfmpeg: 'FFmpeg',
    qsvDiagnosticStageDevice: 'Intel GPU 设备',
    qsvDiagnosticStageCodecs: '所需的 QSV 编解码器',
    qsvDiagnosticStageInitialization: 'Quick Sync 初始化',
    qsvDiagnosticFfmpegMissing: '未安装 FFmpeg，或无法通过 PATH 使用。',
    qsvDiagnosticDeviceMissing: '未找到可访问的 GPU 渲染设备。请将 Intel GPU 渲染设备传递给容器。',
    qsvDiagnosticPermissionDenied: 'Bambuddy 无法访问 GPU 渲染设备。请检查 render 用户组和容器设备权限。',
    qsvDiagnosticDecoderMissing: '此 FFmpeg 构建不包含 h264_qsv 解码器。',
    qsvDiagnosticEncoderMissing: '此 FFmpeg 构建不包含 mjpeg_qsv 编码器。',
    qsvDiagnosticCodecsMissing: '此 FFmpeg 构建不包含所需的 QSV 编解码器。',
    qsvDiagnosticInitializationFailed: '已找到 Intel GPU，但无法初始化 Quick Sync。请检查 Intel Media 驱动程序和 oneVPL 运行时。',
    ...
    qsvDiagnosticTimeout: 'Quick Sync 诊断超时。',
    qsvDiagnosticUnknownFailure: 'Quick Sync 不可用。请打开下方详细信息查看诊断内容。',
    qsvDiagnosticManualDescription: '使用 Intel Quick Sync 前请运行兼容性检查。',
    qsvDiagnosticRun: '运行兼容性检查',
    qsvDiagnosticRunning: '正在检查 Intel Quick Sync 是否可用...',
    qsvDiagnosticRequestFailed: '无法运行 Quick Sync 诊断。',
    qsvDiagnosticRetry: '重新检查',
    qsvDiagnosticAvailable: 'Intel Quick Sync 可用',
    qsvDiagnosticUnavailable: 'Intel Quick Sync 不可用',
    qsvDiagnosticAvailableDescription: '已成功检查 Intel GPU、FFmpeg 编解码器和硬件初始化。',
    qsvDiagnosticHideDetails: '隐藏详细信息',
    qsvDiagnosticShowDetails: '显示详细信息',
