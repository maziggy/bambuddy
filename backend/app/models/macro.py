...
class Macro(Base):
    ...
    file_path: Mapped[str] = mapped_column(String(500))  # relative path to .jinja2 file
...
class MacroRun(Base):
    ...
    trigger: Mapped[str] = mapped_column(String(20), default="manual")  # manual|webhook|schedule|gcode_embed
