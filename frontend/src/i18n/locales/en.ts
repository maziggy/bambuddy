export default {
  ...
  wled: {
    ...
    presetSegmentHint: 'Select the target segment when creating the preset in WLED and enable “Checked segments only”. During runtime, Bambuddy only activates the configured preset.',
