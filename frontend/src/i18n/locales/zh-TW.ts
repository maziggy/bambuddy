  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMapping: '群組對應（JSON）',
        groupMappingHint: '將身分提供者的群組對應到 Bambuddy 群組。可用群組：',
        groupMappingDesc: '對應的群組會在每次登入時同步。此處未列出的群組不會被變更，因此手動分配會保留。留空可停用群組同步。',
        groupMappingInvalidJson: '群組對應必須是 JSON 物件，例如 {"idp-群組": "bambuddy-群組"}。',
        groupMappingUnknownGroups: '未知的 Bambuddy 群組：{{groups}}',
        groupSync: '群組同步',
        groupSyncOn: '開啟',
      },
    },
