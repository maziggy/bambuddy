export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: '視訊處理',
    cameraVideoProcessingSoftware: '軟體處理',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: '使用 CPU 解碼 H.264 並編碼 MJPEG。',
    cameraVideoProcessingIntelQsvDescription: '使用 Intel Quick Sync 進行硬體 H.264 解碼與 MJPEG 編碼。需要支援 QSV/VAAPI 的 FFmpeg，並可存取 DRM 轉譯裝置。',
    ...
    qsvDiagnosticFfmpegMissing: '未安裝 FFmpeg，或無法透過 PATH 使用。',
    qsvDiagnosticDeviceMissing: '找不到可存取的 GPU 算繪裝置。請將 Intel GPU 算繪裝置傳遞至容器。',
    qsvDiagnosticPermissionDenied: 'Bambuddy 無法存取 GPU 算繪裝置。請檢查 render 群組及容器裝置權限。',
    qsvDiagnosticDecoderMissing: '此 FFmpeg 組建不包含 h264_qsv 解碼器。',
    qsvDiagnosticEncoderMissing: '此 FFmpeg 組建不包含 mjpeg_qsv 編碼器。',
    qsvDiagnosticCodecsMissing: '此 FFmpeg 組建不包含所需的 QSV 編解碼器。',
    qsvDiagnosticInitializationFailed: '已找到 Intel GPU，但無法初始化 Quick Sync。請檢查 Intel Media 驅動程式及 oneVPL 執行階段。',
    qsvDiagnosticTimeout: 'Quick Sync 診斷逾時。',
    qsvDiagnosticUnknownFailure: 'Quick Sync 無法使用。請開啟下方詳細資訊查看診斷內容。',
    qsvDiagnosticManualDescription: '使用 Intel Quick Sync 前請執行相容性檢查。',
    qsvDiagnosticRun: '執行相容性檢查',
    qsvDiagnosticRunning: '正在檢查 Intel Quick Sync 是否可用...',
    qsvDiagnosticRequestFailed: '無法執行 Quick Sync 診斷。',
    qsvDiagnosticRetry: '重新檢查',
    qsvDiagnosticAvailable: 'Intel Quick Sync 可用',
    qsvDiagnosticUnavailable: 'Intel Quick Sync 無法使用',
    qsvDiagnosticAvailableDescription: '已成功檢查 Intel GPU、FFmpeg 編解碼器及硬體初始化。',
    qsvDiagnosticHideDetails: '隱藏詳細資訊',
    qsvDiagnosticShowDetails: '顯示詳細資訊',
