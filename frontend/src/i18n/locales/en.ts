export default {
  ...
  printers: {
    ...
    wled: {
      sectionTitle: 'WLED LED Strip',
      sectionDescription: 'Connect a WLED device to show this printer\'s state as a colour on an LED strip.',
      enabledLabel: 'Enable WLED for this printer',
      host: 'WLED Host / IP',
      hostPlaceholder: '192.168.1.50 or wled.local',
      port: 'Port',
      apiKey: 'API Key (optional)',
      apiKeyPlaceholder: 'Leave empty if not set',
      testConnection: 'Test Connection',
      testEffect: 'Flash LED',
      connected: 'Connected',
  ...
  settings: {
    ...
    // WLED
    wled: 'WLED',
    wledDescription: 'Control WLED LED strips to visualize printer status. Each printer connects to its own WLED device and displays the colour defined by the global state map below.',
    enableWled: 'Enable WLED Integration',
    wledEnableDescription: 'Send printer state colours to per-printer WLED devices',
    wledStateMapTitle: 'State Colour Map',
    wledStateMapDescription: 'Define the colour, brightness, and effect for each printer state. All printers share this map.',
    wledStatePrinting: 'Printing',
    wledStateIdle: 'Idle',
    wledStateFinished: 'Finished',
    wledStateError: 'Error / Failed',
    wledStatePaused: 'Paused',
    wledStatePreparing: 'Preparing',
    wledStateOffline: 'Offline / Off',
    wledColour: 'Colour',
    wledBrightness: 'Brightness',
    wledEffectId: 'Effect ID',
    wledEffectIdHint: '0 = Solid. See WLED effects list for IDs.',
    wledPresetId: 'Preset ID',
    wledPresetIdHint: 'If set, activates this WLED preset instead of colour/effect.',
    wledPresetNone: 'None (use colour)',
    // Smart Plugs
