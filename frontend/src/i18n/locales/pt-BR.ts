export default {
  ...
  login: {
    ...
    twoFA: {
      ...
      methodAuthenticator: 'Aplicativo Authenticator',
      methodEmail: 'Código por e-mail',
      methodBackup: 'Código de backup',
      instructionsTotp: 'Abra seu aplicativo autenticador e insira o código de 6 dígitos para o Bambuddy.',
      instructionsEmail: 'Um código de 6 dígitos foi enviado para seu endereço de e-mail. Ele expira em 10 minutos.',
      instructionsEmailNotSent: 'Clique abaixo para receber um código de verificação por e-mail.',
      instructionsBackup: 'Insira um dos seus códigos de backup de 8 caracteres. Cada código só pode ser usado uma vez.',
