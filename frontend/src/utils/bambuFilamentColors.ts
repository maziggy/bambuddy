...
export const BAMBU_FILAMENT_COLORS: Record<string, string> = {
  // PLA Basic (A00)
  'A00-W1': 'Jade White',
  'A00-P0': 'Beige',
  'A00-D2': 'Light Gray',
...
export const BAMBU_COLOR_CODE_FALLBACK: Record<string, string> = {
...
export function getBambuColorName(trayIdName: string | null | undefined): string | null {
