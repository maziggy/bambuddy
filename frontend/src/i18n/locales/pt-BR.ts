export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: 'Processamento de vídeo',
    cameraVideoProcessingSoftware: 'Processamento por software',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: 'Usa a CPU para decodificar H.264 e codificar MJPEG.',
    cameraVideoProcessingIntelQsvDescription: 'Usa o Intel Quick Sync para decodificação H.264 por hardware e codificação MJPEG. Requer FFmpeg com suporte a QSV/VAAPI e acesso a um dispositivo de renderização DRM.',
    cameraVideoProcessingReconnectDescription: 'As alterações entram em vigor depois que o fluxo de câmera compartilhado atual for encerrado e reconectado.',
    qsvDiagnosticStageFfmpeg: 'FFmpeg',
    qsvDiagnosticStageDevice: 'Dispositivo de GPU Intel',
    qsvDiagnosticStageCodecs: 'Codecs QSV necessários',
    qsvDiagnosticStageInitialization: 'Inicialização do Quick Sync',
    qsvDiagnosticFfmpegMissing: 'O FFmpeg não está instalado ou não está disponível no PATH.',
    qsvDiagnosticDeviceMissing: 'Nenhum dispositivo de renderização da GPU acessível foi encontrado. Passe o dispositivo da GPU Intel para o contêiner.',
    qsvDiagnosticPermissionDenied: 'O Bambuddy não consegue acessar o dispositivo de renderização da GPU. Verifique o grupo render e as permissões do dispositivo no contêiner.',
    qsvDiagnosticDecoderMissing: 'Esta compilação do FFmpeg não inclui o decodificador h264_qsv.',
    qsvDiagnosticEncoderMissing: 'Esta compilação do FFmpeg não inclui o codificador mjpeg_qsv.',
    qsvDiagnosticCodecsMissing: 'Esta compilação do FFmpeg não inclui os codecs QSV necessários.',
    qsvDiagnosticInitializationFailed: 'A GPU Intel foi encontrada, mas não foi possível inicializar o Quick Sync. Verifique o driver Intel Media e o runtime oneVPL.',
    ...
    qsvDiagnosticTimeout: 'O diagnóstico do Quick Sync excedeu o tempo limite.',
    qsvDiagnosticUnknownFailure: 'O Quick Sync não está disponível. Abra os detalhes abaixo para consultar as informações de diagnóstico.',
    qsvDiagnosticManualDescription: 'Execute uma verificação de compatibilidade antes de usar o Intel Quick Sync.',
    qsvDiagnosticRun: 'Verificar compatibilidade',
    qsvDiagnosticRunning: 'Verificando a disponibilidade do Intel Quick Sync...',
    qsvDiagnosticRequestFailed: 'Não foi possível executar o diagnóstico do Quick Sync.',
    qsvDiagnosticRetry: 'Verificar novamente',
    qsvDiagnosticAvailable: 'O Intel Quick Sync está disponível',
    qsvDiagnosticUnavailable: 'O Intel Quick Sync não está disponível',
    qsvDiagnosticAvailableDescription: 'A GPU Intel, os codecs do FFmpeg e a inicialização de hardware foram verificados com sucesso.',
    qsvDiagnosticHideDetails: 'Ocultar detalhes',
    qsvDiagnosticShowDetails: 'Mostrar detalhes',
