export default {
  ...
  settings: {
    ...
    keepBedWarmDesc: 'In attesa della conferma di piatto liberato, mantiene il piano alla temperatura target del prossimo elemento così la camera rimane calda. Si applica solo quando la stampa successiva richiede il riscaldamento della camera (ASA, ABS, PA, PC, ecc.). Richiede la conferma di piatto liberato abilitata.',
