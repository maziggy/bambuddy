export default {
  ...
  macros: {
    ...
    noMacros: 'No macros yet. Create one to automate printer actions.',
    name: 'Name',
    description: 'Description',
    script: 'Script',
    ...
    targetPrinter: 'Target Printer',
    anyPrinter: 'Any (specify at run time)',
    runNow: 'Run Now',
    ...
    webhookUrl: 'Webhook URL',
    availableVariables: 'Available Variables',
    availableCommands: 'System Commands',
    gcodeWhitelist: 'Allowed G-codes',
    callMacro: 'Call Another Macro',
    callMacroSyntax: 'Syntax: {{ run_macro("name") }}',
    lastRun: 'Last Run',
    save: 'Save Macro',
    delete: 'Delete Macro',
    confirmDelete: 'Delete this macro? All run history will be lost.',
    noRuns: 'No runs yet.',
    startedAt: 'Started',
    duration: 'Duration',
    settings: 'Settings',
