export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: 'Traitement vidéo',
    cameraVideoProcessingSoftware: 'Traitement logiciel',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: 'Utilise le processeur pour décoder le H.264 et encoder le MJPEG.',
    cameraVideoProcessingIntelQsvDescription: 'Utilise Intel Quick Sync pour le décodage matériel H.264 et l’encodage MJPEG. Nécessite FFmpeg avec la prise en charge de QSV/VAAPI et l’accès à un périphérique de rendu DRM.',
    cameraVideoProcessingReconnectDescription: 'Les modifications prennent effet après l’arrêt et la reconnexion du flux de caméra partagé en cours.',
    qsvDiagnosticStageFfmpeg: 'FFmpeg',
    qsvDiagnosticStageDevice: 'Périphérique GPU Intel',
    qsvDiagnosticStageCodecs: 'Codecs QSV requis',
    qsvDiagnosticStageInitialization: 'Initialisation de Quick Sync',
    qsvDiagnosticFfmpegMissing: "FFmpeg n'est pas installé ou n'est pas disponible dans PATH.",
    qsvDiagnosticDeviceMissing: "Aucun périphérique de rendu GPU accessible n'a été trouvé. Transmettez le périphérique du GPU Intel au conteneur.",
    qsvDiagnosticPermissionDenied: 'Bambuddy ne peut pas accéder au périphérique de rendu GPU. Vérifiez le groupe render et les permissions du périphérique dans le conteneur.',
    qsvDiagnosticDecoderMissing: 'Cette version de FFmpeg ne fournit pas le décodeur h264_qsv.',
    qsvDiagnosticEncoderMissing: "Cette version de FFmpeg ne fournit pas l'encodeur mjpeg_qsv.",
    qsvDiagnosticCodecsMissing: 'Cette version de FFmpeg ne fournit pas les codecs QSV requis.',
    qsvDiagnosticInitializationFailed: "Le GPU Intel a été détecté, mais Quick Sync n'a pas pu être initialisé. Vérifiez le pilote Intel Media et l'environnement d'exécution oneVPL.",
    ...
    qsvDiagnosticTimeout: 'Le diagnostic Quick Sync a dépassé le délai imparti.',
    qsvDiagnosticUnknownFailure: "Quick Sync n'est pas disponible. Ouvrez les détails ci-dessous pour consulter le diagnostic.",
    qsvDiagnosticManualDescription: "Lancez un test de compatibilité avant d'utiliser Intel Quick Sync.",
    qsvDiagnosticRun: 'Tester la compatibilité',
    qsvDiagnosticRunning: "Vérification de la disponibilité d'Intel Quick Sync...",
    qsvDiagnosticRequestFailed: "Impossible d'exécuter le diagnostic Quick Sync.",
    qsvDiagnosticRetry: 'Vérifier à nouveau',
    qsvDiagnosticAvailable: 'Intel Quick Sync est disponible',
    qsvDiagnosticUnavailable: "Intel Quick Sync n'est pas disponible",
    qsvDiagnosticAvailableDescription: "Le GPU Intel, les codecs FFmpeg et l'initialisation matérielle ont été vérifiés avec succès.",
    qsvDiagnosticHideDetails: 'Masquer les détails',
    qsvDiagnosticShowDetails: 'Afficher les détails',
