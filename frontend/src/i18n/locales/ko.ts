  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMapping: '그룹 매핑 (JSON)',
        groupMappingHint: 'IdP 그룹을 Bambuddy 그룹에 매핑합니다. 사용 가능한 그룹:',
        groupMappingDesc: '매핑된 그룹은 로그인할 때마다 동기화됩니다. 여기에 지정되지 않은 그룹은 변경되지 않으므로 수동 할당이 유지됩니다. 비워 두면 그룹 동기화가 비활성화됩니다.',
        groupMappingInvalidJson: '그룹 매핑은 {"idp-그룹": "bambuddy-그룹"} 형식의 JSON 객체여야 합니다.',
        groupMappingUnknownGroups: '알 수 없는 Bambuddy 그룹: {{groups}}',
        groupSync: '그룹 동기화',
        groupSyncOn: '켜짐',
      },
