  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMappingHint: 'Kimlik sağlayıcı gruplarını Bambuddy gruplarına eşleyin. Kullanılabilir gruplar:',
        ...
        groupMappingInvalidJson: 'Grup eşlemesi {"idp-grup": "bambuddy-grup"} gibi bir JSON nesnesi olmalıdır.',
        groupMappingUnknownGroups: 'Bilinmeyen Bambuddy grupları: {{groups}}',
