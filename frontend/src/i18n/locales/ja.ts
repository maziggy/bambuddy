export default {
  ...
  settings: {
    ...
    // Users
    userAuth: 'ユーザー認証',
    userAuthDescription: '認証を有効にしてBambuddyインスタンスを保護し、ユーザーアクセスを管理します。',
    authDisabled: '認証が無効',
    authDisabledDescription: 'Bambuddyインスタンスは現在、認証なしでアクセス可能です。',
    enableAuthTo: '認証を有効にすると:',
    authBenefitLogin: 'システムへのアクセスにログインが必要',
    authBenefitUsers: '異なる役割の複数ユーザーを管理',
    authBenefitAccess: 'プリンター設定とユーザー管理へのアクセスを制御',
    activateAuth: '認証を有効化',
    authEnabled: '認証が有効',
    authEnabledDescription: 'Bambuddyインスタンスは認証で保護されています。',
    currentUser: '現在のユーザー',
    role: 'ロール:',
    roleAdmin: '管理者',
    roleUser: 'ユーザー',
