export default {
  ...
  virtualPrinter: {
    ...
    howItWorks: {
      ...
      intro: 'Jeder virtuelle Drucker erscheint in Bambu Studio / OrcaSlicer über SSDP-Erkennung. Erstelle mehrere Drucker mit verschiedenen Modi:',
      archiveDesc: '3MF-Dateien an diesen Drucker werden direkt im Archiv gespeichert.',
      reviewDesc: 'Dateien werden zur Überprüfung zurückgehalten. Du genehmigst oder verwirfst jeden Upload vor der Archivierung.',
      queueDesc: 'Dateien werden archiviert und automatisch zur Druckwarteschlange hinzugefügt (nicht zugewiesen).',
      proxyDesc: 'Datenverkehr wird an einen echten Drucker weitergeleitet. Erfordert eine dedizierte IP pro Proxy (Interface-Alias).',
    },
    status: {
