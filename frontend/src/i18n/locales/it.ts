export default {
  ...
  settings: {
    ...
    sidebarOrderSetDefaultHint: 'Imposta predefinito applica il menu come configurato a tutti i nuovi utenti.',
    sidebarDefaultSet: 'Ordine predefinito del menu impostato per i nuovi utenti.',
