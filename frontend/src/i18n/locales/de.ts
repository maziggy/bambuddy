export default {
  ...
  printers: {
    ...
    cameraGrid: {
      ...
      reconnecting: 'Neuverbindung in {{countdown}}s ({{attempt}}/{{max}})',
      expand: 'Vergrößern',
      layout: {
        compact: 'Kompakt',
        default: 'Standard',
  ...
  settings: {
    ...
    cameraQualityAuto: 'Automatisch (Empfohlen)',
    cameraQualityAutoResolved: 'Automatisch gewählt: {{resolved}} basierend auf Server-Hardware und Druckeranzahl.',
