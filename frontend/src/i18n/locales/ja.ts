export default {
  ...
  settings: {
    ...
    barcodeScan: {
      ...
      enableLookupDesc: 'スキャンしたバーコードがまだ在庫にない場合、コミュニティのOpen Filament Databaseを照会します。オフにすると、以前にスキャンしたバーコードのみと照合します — スキャン機能自体は常に動作します。',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualInvalid: '有効なUPC-A、EAN-8、またはEAN-13のバーコードを入力してください（8、12、または13桁）',
      lookUp: '検索',
