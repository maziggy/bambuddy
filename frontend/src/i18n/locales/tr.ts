export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: 'QR ile ata',
      title: 'Atama hedefini seç',
      description: 'Bir hedef seç, sonra makara QR kodunu okutarak oraya ata.',
      tabAms: 'AMS yuvası',
      tabStorage: 'Depo',
      printer: 'Yazıcı',
      ...
      scanningTarget: 'Hedef: {{location}}',
      back: 'Geri',
      invalidQr: 'Bu QR kodu bir makara etiketi değil.',
      takePhoto: 'Fotoğraf çek',
      noQrInPhoto: 'Fotoğrafta QR kodu bulunamadı — tekrar deneyin.',
      decoding: 'Okunuyor…',
      assignSuccess: '{{location}} konumuna atandı',
      storageSuccess: '{{location}} konumuna taşındı',
      assignFailed: '{{location}} konumuna atanamadı',
    },
