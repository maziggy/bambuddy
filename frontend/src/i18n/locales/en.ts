export default {
  ...
  settings: {
    ...
    keepBedWarmDesc: 'While awaiting plate-clear, maintain the bed at the next item\'s target temperature so the chamber stays hot. Only applies when the next print needs chamber heating (ASA, ABS, PA, PC etc.). Requires plate-clear confirmation to be enabled.',
