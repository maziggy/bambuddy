export default {
  ...
  login: {
    ...
    twoFA: {
      ...
      subtitle: 'Il tuo account è protetto con 2FA. Inserisci il codice di verifica qui sotto.',
      methodAuthenticator: 'App Authenticator',
      methodEmail: 'Codice via e-mail',
      methodBackup: 'Codice di backup',
      instructionsTotp: 'Apri la tua app authenticator e inserisci il codice a 6 cifre per Bambuddy.',
      instructionsEmail: 'Un codice a 6 cifre è stato inviato al tuo indirizzo e-mail. Scade in 10 minuti.',
      instructionsEmailNotSent: 'Clicca qui sotto per ricevere un codice di verifica via e-mail.',
      instructionsBackup: 'Inserisci uno dei tuoi codici di backup a 8 caratteri. Ogni codice può essere utilizzato una sola volta.',
