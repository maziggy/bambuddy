export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: 'QRで割り当て',
      title: '割り当て先を選択',
      description: '割り当て先を選んでから、スプールのQRをスキャンしてそこに割り当てます。',
      tabAms: 'AMSスロット',
      tabStorage: '保管',
      printer: 'プリンター',
      selectSlot: 'スロットを選択',
      ...
      scanInstruction: 'スプールラベルのQRコードにカメラを向けてください。',
      scanningTarget: '割り当て先: {{location}}',
      back: '戻る',
      invalidQr: 'このQRコードはスプールラベルではありません。',
      cameraDenied: 'カメラへのアクセスが拒否されました。カメラの権限を許可して再試行してください。',
      cameraInsecure: 'カメラには安全な（HTTPS）接続が必要です。',
      cameraNoDevice: 'この端末でカメラが見つかりませんでした。',
      assignSuccess: '{{location}} に割り当てました',
      storageSuccess: '{{location}} に移動しました',
      assignFailed: '{{location}} に割り当てできませんでした',
    },
