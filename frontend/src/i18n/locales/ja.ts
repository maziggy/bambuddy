export default {
  ...
  printers: {
    ...
    enclosure: {
      sectionTitle: 'エンクロージャー',
      temperature: '温度',
      humidity: '湿度',
      fan: 'エンクロージャーファン',
      fanOn: 'ON',
      fanOff: 'OFF',
      noEntitiesHint: 'プリンター設定でHome Assistantのセンサーエンティティを設定すると、測定値が表示されます。',
      noDataHint: 'まだデータがありません — 設定 → 統合でHome Assistantが設定されているか確認してください。',
      haNotConfiguredWarning: 'Home Assistantが設定されていません。設定 → 統合に移動して、まずHA URLとトークンを入力してください。',
      editLabel: 'エンクロージャー付きプリンター',
      editDescription: 'プリンターカードに温度・湿度用の専用エンクロージャーセクションを表示します。',
      editEntitiesHint: 'エンクロージャーセンサーのHome AssistantエンティティIDを入力してください。測定値は60秒ごとに更新されます。',
      tempEntity: '温度エンティティ',
      humidityEntity: '湿度エンティティ',
      fanEntity: 'ファンエンティティ',
      historyTitle: 'エンクロージャー履歴',
      currentTemp: '現在の温度',
      currentHumidity: '現在の湿度',
      minMax: '最小 / 最大',
      tempChartLabel: '温度 ({{unit}})',
      humidityChartLabel: '湿度 ({{unit}})',
      noReadings: 'この期間に記録された測定値はありません。',
      readingsNote: 'BamBuddy動作中、測定値は60秒ごとに記録されます。',
      fanHistoryTitle: 'エンクロージャーファン履歴',
      fanTotalRuntime: '合計稼働時間',
      fanRuns: '稼働回数',
      fanAvgRun: '平均稼働時間',
      fanLongestRun: '最長稼働時間',
      fanNoActivity: 'この期間にファンの動作は記録されていません。',
      pollNote: 'BamBuddy動作中、状態は60秒ごとに確認されます。',
    },
    progress: '{{percent}}% 完了',
    ...
    wled: {
      sectionTitle: 'WLED LEDテープ',
      sectionDescription: 'WLEDデバイスを接続して、このプリンターの状態をLEDテープの色で表示します。',
      enabledLabel: 'このプリンターでWLEDを有効にする',
      host: 'WLEDホスト / IPアドレス',
      hostPlaceholder: '192.168.1.50 または wled.local',
      port: 'ポート',
      apiKey: 'APIキー（任意）',
      apiKeyPlaceholder: '設定しない場合は空欄のまま',
      testConnection: '接続テスト',
      testEffect: 'LEDを点滅させる',
      connected: '接続済み',
      disconnected: '到達不能',
  ...
  storage: {
    title: 'フィラメント保管',
    emptyState: 'ユニットがありません。乾燥機またはドライボックスを追加してください。',
    addUnit: 'ユニットを追加',
    editUnit: 'ユニットを編集',
    deleteUnit: 'ユニットを削除',
    deleteConfirm: '"{{name}}"を削除しますか？すべての履歴データも削除されます。',
    typeDryer: '乾燥機',
    typeStorage: 'ドライボックス・保管',
    filterAll: 'すべて',
    filterDryers: '乾燥機',
    filterStorage: 'ドライボックス',
    temperature: '温度',
    humidity: '湿度',
    noReading: 'まだ読み取りなし',
    noEntitiesHint: 'HAセンサーエンティティが未設定です — 編集から追加してください。',
    noDataHint: 'エンティティは設定済みですが、データがまだありません。HAポーリングは60秒ごとです。',
    historyTitle: 'センサー履歴',
    history24h: '直近24時間',
    history48h: '直近48時間',
    history7d: '直近7日間',
    noHistory: '選択した期間にデータがありません。',
    modalNameLabel: '名前',
    modalNamePlaceholder: '例: Sunlu S1 Plus、ドライボックスA',
    modalTypeLabel: 'タイプ',
    modalTempEntityLabel: 'HA 温度エンティティ',
    modalTempEntityPlaceholder: 'sensor.dryer_temperature',
    modalHumidityEntityLabel: 'HA 湿度エンティティ',
    modalHumidityEntityPlaceholder: 'sensor.dryer_humidity',
    modalNotesLabel: 'メモ（任意）',
    modalNotesPlaceholder: '例: PETG + PA を 70°C で乾燥中',
    modalSave: '保存',
    modalCancel: 'キャンセル',
    savedToast: '保管ユニットを保存しました',
    deletedToast: '保管ユニットを削除しました',
  },
  ...
  settings: {
    ...
    // WLED
    wled: 'WLED',
    wledDescription: 'WLED LEDテープを制御してプリンターの状態を視覚化します。各プリンターは専用のWLEDデバイスに接続し、下のグローバル状態マップで定義された色を表示します。',
    enableWled: 'WLED統合を有効にする',
    wledEnableDescription: 'プリンターの状態の色を各プリンターのWLEDデバイスに送信する',
    wledStateMapTitle: '状態カラーマップ',
    wledStateMapDescription: '各プリンター状態の色・輝度・エフェクトを設定します。すべてのプリンターでこのマップを共有します。',
    wledStatePrinting: '印刷中',
    wledStateIdle: 'アイドル',
    wledStateFinished: '完了',
    wledStateError: 'エラー / 失敗',
    wledStatePaused: '一時停止中',
    wledStatePreparing: '準備中',
    wledStateOffline: 'オフライン / オフ',
    wledColour: '色',
    wledBrightness: '輝度',
    wledEffectId: 'エフェクトID',
    wledEffectIdHint: '0 = 単色。IDはWLEDエフェクト一覧を参照してください。',
    wledPresetId: 'プリセットID',
    wledPresetIdHint: '設定すると、色/エフェクトの代わりにこのWLEDプリセットを有効にします。',
    wledPresetNone: 'なし（色を使用）',
    // Smart Plugs
