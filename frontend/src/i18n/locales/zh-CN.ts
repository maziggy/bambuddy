export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: '通过二维码分配',
      title: '选择分配目标',
      description: '先选择目标，然后扫描耗材二维码即可将其分配到那里。',
      tabAms: 'AMS 槽位',
      tabStorage: '存储',
      printer: '打印机',
      selectSlot: '选择一个槽位',
      ...
      startScan: '设置目标并扫描',
      scanTitle: '扫描耗材二维码',
      scanInstruction: '将摄像头对准耗材标签上的二维码。',
      scanningTarget: '目标：{{location}}',
      back: '返回',
      invalidQr: '该二维码不是耗材标签。',
      cameraDenied: '摄像头访问被拒绝。请允许摄像头权限后重试。',
      cameraInsecure: '摄像头需要安全（HTTPS）连接。',
      cameraNoDevice: '此设备上未找到摄像头。',
      assignSuccess: '已分配到 {{location}}',
      storageSuccess: '已移动到 {{location}}',
      assignFailed: '无法分配到 {{location}}',
    },
    spoolArchived: '耗材已归档',
    spoolRestored: '耗材已恢复',
