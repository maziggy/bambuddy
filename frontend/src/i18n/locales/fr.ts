export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: 'Affecter par QR',
      title: 'Choisir la cible d’affectation',
      description: 'Choisissez une cible, puis scannez le QR d’une bobine pour l’y affecter.',
      tabAms: 'Emplacement AMS',
      tabStorage: 'Stockage',
      printer: 'Imprimante',
      ...
      scanInstruction: 'Pointez la caméra vers le QR code d’une étiquette de bobine.',
      scanningTarget: 'Cible : {{location}}',
      back: 'Retour',
      invalidQr: 'Ce QR code n’est pas une étiquette de bobine.',
      cameraDenied: 'L’accès à la caméra a été refusé. Autorisez la caméra et réessayez.',
      cameraInsecure: 'La caméra nécessite une connexion sécurisée (HTTPS).',
      cameraNoDevice: 'Aucune caméra n’a été trouvée sur cet appareil.',
      assignSuccess: 'Affectée à {{location}}',
      storageSuccess: 'Déplacée vers {{location}}',
      assignFailed: 'Impossible d’affecter à {{location}}',
    },
