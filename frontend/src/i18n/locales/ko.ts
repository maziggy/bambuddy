export default {
  ...
  settings: {
    ...
    cameraVideoProcessing: '비디오 처리',
    cameraVideoProcessingSoftware: '소프트웨어 처리',
    cameraVideoProcessingIntelQsv: 'Intel Quick Sync',
    cameraVideoProcessingSoftwareDescription: 'CPU를 사용하여 H.264를 디코딩하고 MJPEG를 인코딩합니다.',
    cameraVideoProcessingIntelQsvDescription: 'Intel Quick Sync를 사용하여 H.264 하드웨어 디코딩과 MJPEG 인코딩을 수행합니다. QSV/VAAPI를 지원하는 FFmpeg와 DRM 렌더 장치 접근 권한이 필요합니다.',
    ...
    qsvDiagnosticStageInitialization: 'Quick Sync 초기화',
    qsvDiagnosticFfmpegMissing: 'FFmpeg가 설치되어 있지 않거나 PATH에서 사용할 수 없습니다.',
    qsvDiagnosticDeviceMissing: '접근 가능한 GPU 렌더링 장치를 찾을 수 없습니다. Intel GPU 렌더링 장치를 컨테이너에 전달하세요.',
    qsvDiagnosticPermissionDenied: 'Bambuddy가 GPU 렌더링 장치에 접근할 수 없습니다. render 그룹과 컨테이너 장치 권한을 확인하세요.',
    qsvDiagnosticDecoderMissing: '이 FFmpeg 빌드에는 h264_qsv 디코더가 없습니다.',
    qsvDiagnosticEncoderMissing: '이 FFmpeg 빌드에는 mjpeg_qsv 인코더가 없습니다.',
    qsvDiagnosticCodecsMissing: '이 FFmpeg 빌드에는 필요한 QSV 코덱이 없습니다.',
    qsvDiagnosticInitializationFailed: 'Intel GPU를 찾았지만 Quick Sync를 초기화할 수 없습니다. Intel Media 드라이버와 oneVPL 런타임을 확인하세요.',
    ...
    qsvDiagnosticTimeout: 'Quick Sync 진단 시간이 초과되었습니다.',
    qsvDiagnosticUnknownFailure: 'Quick Sync를 사용할 수 없습니다. 아래 세부 정보를 열어 진단 내용을 확인하세요.',
    qsvDiagnosticManualDescription: 'Intel Quick Sync를 사용하기 전에 호환성 검사를 실행하세요.',
    qsvDiagnosticRun: '호환성 검사',
    qsvDiagnosticRunning: 'Intel Quick Sync 사용 가능 여부를 확인하는 중...',
    qsvDiagnosticRequestFailed: 'Quick Sync 진단을 실행할 수 없습니다.',
    qsvDiagnosticRetry: '다시 확인',
    qsvDiagnosticAvailable: 'Intel Quick Sync를 사용할 수 있습니다',
    qsvDiagnosticUnavailable: 'Intel Quick Sync를 사용할 수 없습니다',
    qsvDiagnosticAvailableDescription: 'Intel GPU, FFmpeg 코덱 및 하드웨어 초기화를 성공적으로 확인했습니다.',
    qsvDiagnosticHideDetails: '세부 정보 숨기기',
    qsvDiagnosticShowDetails: '세부 정보 표시',
