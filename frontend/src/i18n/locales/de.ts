export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: 'Per QR zuweisen',
      title: 'Zuweisungsziel wählen',
      description: 'Wähle ein Ziel und scanne dann einen Spulen-QR-Code, um sie dort zuzuweisen.',
      tabAms: 'AMS-Steckplatz',
      tabStorage: 'Lager',
      printer: 'Drucker',
      ...
      scanInstruction: 'Richte die Kamera auf den QR-Code eines Spulenetiketts.',
      scanningTarget: 'Ziel: {{location}}',
      back: 'Zurück',
      invalidQr: 'Dieser QR-Code ist kein Spulenetikett.',
      cameraDenied: 'Kamerazugriff wurde verweigert. Erlaube die Kameraberechtigung und versuche es erneut.',
      cameraInsecure: 'Die Kamera benötigt eine sichere (HTTPS-)Verbindung.',
      cameraNoDevice: 'Auf diesem Gerät wurde keine Kamera gefunden.',
      assignSuccess: 'Zugewiesen zu {{location}}',
      storageSuccess: 'Verschoben nach {{location}}',
      assignFailed: 'Zuweisung zu {{location}} fehlgeschlagen',
    },
