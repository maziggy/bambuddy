export default {
  ...
  settings: {
    ...
    sidebarOrderSetDefaultHint: 'Definir padrão para definir a ordem padrão do menu para todos os usuários.',
    sidebarDefaultSet: 'Ordem padrão do menu definida para todos os usuários.',
