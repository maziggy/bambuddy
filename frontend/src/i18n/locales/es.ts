export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: 'Asignar por QR',
      title: 'Elegir destino de asignación',
      description: 'Elige un destino y luego escanea el QR de una bobina para asignarla allí.',
      tabAms: 'Ranura AMS',
      ...
      scanInstruction: 'Apunta la cámara al código QR de la etiqueta de una bobina.',
      scanningTarget: 'Destino: {{location}}',
      back: 'Atrás',
      invalidQr: 'Ese código QR no es una etiqueta de bobina.',
      cameraDenied: 'Se denegó el acceso a la cámara. Permite el permiso de cámara e inténtalo de nuevo.',
      cameraInsecure: 'La cámara necesita una conexión segura (HTTPS).',
      cameraNoDevice: 'No se encontró ninguna cámara en este dispositivo.',
      assignSuccess: 'Asignada a {{location}}',
      storageSuccess: 'Movida a {{location}}',
      assignFailed: 'No se pudo asignar a {{location}}',
    },
