  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMapping: 'Mappatura gruppi (JSON)',
        groupMappingHint: 'Mappa i gruppi del provider di identità sui gruppi Bambuddy. Gruppi disponibili:',
        ...
        groupMappingInvalidJson: 'La mappatura dei gruppi deve essere un oggetto JSON come {"gruppo-idp": "gruppo-bambuddy"}.',
        groupMappingUnknownGroups: 'Gruppo/i Bambuddy sconosciuto/i: {{groups}}',
