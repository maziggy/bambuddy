export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: 'Assign by QR',
      title: 'Choose assignment target',
      description: 'Pick a target, then scan a spool QR to assign it there.',
      tabAms: 'AMS slot',
      tabStorage: 'Storage',
      printer: 'Printer',
      ...
      scanInstruction: 'Point the camera at a spool label QR code.',
      scanningTarget: 'Target: {{location}}',
      back: 'Back',
      invalidQr: 'That QR code is not a spool label.',
      cameraDenied: 'Camera access was denied. Allow camera permission and try again.',
      cameraInsecure: 'Camera needs a secure (HTTPS) connection.',
      cameraNoDevice: 'No camera was found on this device.',
      assignSuccess: 'Assigned to {{location}}',
      storageSuccess: 'Moved to {{location}}',
      assignFailed: 'Could not assign to {{location}}',
    },
