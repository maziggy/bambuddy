...
EVENT_VARIABLES: dict[str, list[str]] = {
    "print_start": ["printer", "printer_alias", "filename", "estimated_time", "eta", "timestamp", "app_name"],
    "print_complete": [
        "printer",
        "printer_alias",
        "filename",
    ...
    "print_progress": ["printer", "printer_alias", "filename", "progress", "remaining_time", "eta", "timestamp", "app_name"],
    ...
    "ams_temperature_high": ["printer", "printer_alias", "ams_label", "temperature", "threshold", "timestamp", "app_name"],
    ...
    "queue_job_assigned": ["job_name", "printer", "printer_alias", "target_model", "timestamp", "app_name"],
    "queue_job_started": ["printer", "printer_alias", "job_name", "estimated_time", "eta", "timestamp", "app_name"],
