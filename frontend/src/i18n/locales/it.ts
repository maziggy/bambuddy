export default {
  ...
  printers: {
    ...
    partRemoval: {
      ...
      pausedForRemoval: 'In Elaborazione: {{jobName}} - In Pausa per Conferma Rimozione Pezzo Precedente',
      onDeckPausedForRemoval: 'In Elaborazione: {{jobName}} - In Pausa per Conferma Rimozione Pezzo Precedente',
