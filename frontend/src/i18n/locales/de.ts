export default {
  ...
  printers: {
    ...
    enclosure: {
      ...
      fanEntity: 'Fan entity',
      historyTitle: 'Enclosure History',
      currentTemp: 'Current Temp',
      currentHumidity: 'Current Humidity',
      minMax: 'Min / Max',
      tempChartLabel: 'Temperature ({{unit}})',
      humidityChartLabel: 'Humidity ({{unit}})',
      noReadings: 'No readings recorded in this time range.',
      readingsNote: 'Readings are recorded every 60 seconds while BamBuddy is running.',
      fanHistoryTitle: 'Enclosure Fan History',
      fanTotalRuntime: 'Total runtime',
      fanRuns: 'Runs',
      fanAvgRun: 'Avg run',
      fanLongestRun: 'Longest run',
      fanNoActivity: 'No fan activity recorded in this time range.',
      pollNote: 'State is checked every 60 seconds while BamBuddy is running.',
    },
