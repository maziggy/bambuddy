export default {
  ...
  settings: {
    ...
    keepBedWarmDesc: 'Enquanto aguarda a confirmação de placa limpa, mantém a mesa na temperatura alvo do próximo item para que a câmara permaneça aquecida. Aplica-se apenas quando a próxima impressão requer aquecimento de câmara (ASA, ABS, PA, PC, etc.). Requer a confirmação de placa limpa ativada.',
