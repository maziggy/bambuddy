  ...
  settings: {
    ...
    oidc: {
      ...
      form: {
        ...
        groupMapping: 'グループマッピング（JSON）',
        groupMappingHint: 'IdP のグループを Bambuddy のグループに関連付けます。利用可能なグループ：',
        groupMappingDesc: 'マッピングされたグループはログインのたびに同期されます。ここに記載のないグループは変更されないため、手動割り当ては保持されます。空欄にするとグループ同期は無効になります。',
        groupMappingInvalidJson: 'グループマッピングは {"idp-グループ": "bambuddy-グループ"} のような JSON オブジェクトである必要があります。',
        groupMappingUnknownGroups: '不明な Bambuddy グループ: {{groups}}',
        groupSync: 'グループ同期',
        groupSyncOn: 'オン',
      },
    },
