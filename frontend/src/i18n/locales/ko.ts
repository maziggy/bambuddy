export default {
  ...
  inventory: {
    ...
    qrAssign: {
      button: 'QR로 할당',
      title: '할당 대상 선택',
      description: '대상을 먼저 선택한 다음 스풀 QR을 스캔하여 할당하세요.',
      tabAms: 'AMS 슬롯',
      tabStorage: '보관',
      printer: '프린터',
      selectSlot: '슬롯 선택',
      ...
      scanningTarget: '대상: {{location}}',
      back: '뒤로',
      invalidQr: '이 QR 코드는 스풀 라벨이 아닙니다.',
      takePhoto: '사진 찍기',
      noQrInPhoto: '사진에서 QR 코드를 찾을 수 없음 — 다시 시도하세요.',
      decoding: '읽는 중…',
      assignSuccess: '{{location}}에 할당됨',
      storageSuccess: '{{location}}(으)로 이동됨',
      assignFailed: '{{location}}에 할당할 수 없음',
    },
